...
func (q *Queries) GetRule(ctx context.Context, id int64) (GetRuleRow, error) {
...
func (q *Queries) InsertRule(ctx context.Context, arg InsertRuleParams) (InsertRuleRow, error) {
...
func (q *Queries) ListRules(ctx context.Context, companyID int64) ([]ListRulesRow, error) {
	rows, err := q.db.Query(ctx, listRules, companyID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
