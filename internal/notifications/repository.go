...
func (r *Repository) Create(ctx context.Context, n Notification) (Notification, error) {
	...
	err := r.db.QueryRow(ctx, `INSERT INTO notifications (recipient_id, type, title, body, url)
		VALUES ($1,$2,$3,$4,$5)
		RETURNING id, recipient_id, type, title, body, url, read_at, created_at, updated_at`,
		n.RecipientID, n.Type, n.Title, n.Body, n.URL).Scan(
		&n.ID, &n.RecipientID, &n.Type, &n.Title, &n.Body, &n.URL, &n.ReadAt, &n.CreatedAt, &n.UpdatedAt)
	return n, err
}

func (r *Repository) ListRecent(ctx context.Context, recipientID int64, limit int) ([]Notification, error) {
	rows, err := r.db.Query(ctx, `SELECT id, recipient_id, type, title, body, url, read_at, created_at, updated_at
	...
	for rows.Next() {
		var n Notification
		if err := rows.Scan(&n.ID, &n.RecipientID, &n.Type, &n.Title, &n.Body, &n.URL, &n.ReadAt, &n.CreatedAt, &n.UpdatedAt); err != nil {
			return nil, err
		}
