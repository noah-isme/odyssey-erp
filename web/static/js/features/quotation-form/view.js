...
export const view = {
    ...
    render(id, state) {
        ...
        // Optimization: In a real app we'd diff, but for this refactor we'll idempotent-render
        // To avoid losing focus, we can check if we just added/removed a line
    ...
    createLineItemHTML(line, index) {
        ...
        <div class="line-item p-4 bg-surface-muted border rounded-md mb-4" data-index="${index}">
            <div class="grid grid-cols-3 gap-4">
                <div class="field">
                    <label for="product_id_${index}" class="label">Product ID <span class="text-error">*</span></label>
