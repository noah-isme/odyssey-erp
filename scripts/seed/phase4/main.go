...
func seedMappings(ctx context.Context, pool *pgxpool.Pool) error {
	mappings := map[string]string{
		...
		"ap.payment.ap":                  "2100",
		"ap.payment.fx_gain":             "4200",
		"ap.payment.fx_loss":             "5200",
		"inventory.adjustment.gain":      "5300",
		"inventory.adjustment.loss":      "5300",
		"inventory.adjustment.inventory": "1300",
		"ar.invoice.ar":                  "1200",
		"ar.invoice.revenue":             "4000",
		"ar.invoice.tax":                 "4160",
		"ar.payment.fx_gain":             "4200",
		"ar.payment.fx_loss":             "5200",
		"fx.realized.gain":               "4200",
		"fx.realized.loss":               "5200",
		"fx.revaluation.gain":            "4200",
		"fx.revaluation.loss":            "5200",
		"ar.credit_note.ar":              "1200",
