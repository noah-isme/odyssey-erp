# Graph Report - odyssey-erp  (2026-08-20)

## Corpus Check
- 1522 files · ~991,067 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19273 nodes · 39951 edges · 1296 communities (1211 shown, 85 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 2504 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1cc130f1`
...
## Communities (1296 total, 85 thin omitted)

### Community 0 - "models.go"
Cohesion: 0.02
Nodes (334): Date, Float8, Int8, Numeric, Text, Timestamp, Timestamptz, AccountingPeriod (+326 more)
...
### Community 32 - "freight/repository.go"
Cohesion: 0.13
...
Cohesion: 0.11
Nodes (24): DashboardPayload, mergedBucket, AgingBucket, KPISummary, PLTrendPoint, Writer, WriteAgingCSV(), WriteCashflowTrendCSV() (+16 more)
...
Cohesion: 0.08
Nodes (34): Blob, ClassificationLevel, CollaborationChange, CollaborationSession, DispositionExecutionUpdate, DispositionRequest, Document, DocumentAccessEvent (+26 more)
...
### Community 181 - "postgresRepository"
Cohesion: 0.15
...
### Community 211 - "ContractRepository"
Cohesion: 0.15
...
Cohesion: 0.18
Nodes (9): mockPoster, mockRepo, StatementImportRunCreate, BankAccount, BankTransaction, Context, JournalEntry, StatementImportRun (+1 more)
...
### Community 322 - "Text"
Cohesion: 0.11
Nodes (10): Addr, Text, IndexDocumentSearchParams, InsertDocumentAccessEventParams, InsertDocumentLinkParams, InsertDocumentVersionParams, InsertLegalHoldParams, InsertReviewDecisionParams (+2 more)

### Community 323 - "settlementServiceFixture"
Cohesion: 0.13
...
### Community 350 - "NewSessionManager"
Cohesion: 0.13
...
### Community 352 - "Settlement"
Cohesion: 0.09
Nodes (23): Instruction, Time, Context, Instruction, Submission, Context, Instruction, Submission (+15 more)
...
### Community 354 - "Int8"
Cohesion: 0.13
Nodes (8): Int8, GetLatestDocumentVersionRow, InsertDocumentACLParams, InsertDocumentCategoryParams, InsertDocumentParams, ReleaseLegalHoldParams, SetCurrentDocumentVersionParams, UpdateDocumentParams

### Community 355 - "ReportingDataset"
Cohesion: 0.17
...
Cohesion: 0.23
Nodes (14): barAdapter, lineAdapter, stubPDF, stubRBAC, stubValidator, Context, Handler, T (+6 more)
...
### Community 914 - "NewGLPostingService"
Cohesion: 0.58
...
Cohesion: 0.22
Nodes (12): BankAccount, BankAccountCreate, BankStatement, BankStatementCreate, BankStatementLineCreate, BankTransaction, BankTransactionCreate, BankTransactionStatusUpdate (+4 more)
...
### Community 1057 - "Manual QA Checklist (Cycle 9.3)"
Cohesion: 0.33
...
### Community 1129 - ".CreateAPRealizedFXJournalTx"
Cohesion: 0.24
...
### Community 1152 - "Stakeholder Sign-Off"
Cohesion: 0.40
...
### Community 1157 - "NonConformanceReport"
Cohesion: 0.22
Nodes (7): CustomerComplaint, toComplaint(), toComplaintFromList(), toNCR(), valueOrZero(), CreateComplaintRequest, NonConformanceReport

### Community 1158 - "TestNormaliseStatus"
Cohesion: 0.67
Nodes (3): T, TestNormaliseStatus(), TestServiceRejectsInvalidRequestsWithoutRepository()
...
### Community 1160 - "NewPaymentRecoveryRepository"
Cohesion: 0.44
...
### Community 1219 - "KPIFilter"
Cohesion: 0.33
Nodes (5): KPIFilter, KPISummary, Service, Context, Time

### Community 1220 - "NewService"
Cohesion: 0.20
Nodes (17): orderedBankRepo, BankTransaction, Context, T, UUID, newMockTransactionID(), TestBankAccountSummariesAddOpeningAndTransactionAmounts(), TestCreateOperationsRejectInvalidInputsBeforeRepository() (+9 more)
...
### Community 1309 - "Native Development Setup"
Cohesion: 0.50
...
- `SessionFromContext()` (2× useful, score=1.548752148)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Parse()` connect `Parse` to `BatchExecutionEnqueuer`, `service_bs.go`, `Handler`, `distribution/handler.go`, `Handler`, `ap/repository.go`, `Handler`, `Handler`, `CSRFManager`, `certification_test.go`, `Handler`, `BalanceSheetHandler`, `Handler`, `PermissionsHandler`, `CoretaxService`, `distribution/repository.go`, `SignatureChallengeService`, `SourcingService`, `Service`, `SessionFromContext`, `freight/repository.go`, `ParseCSV`, `Context`, `regression_test.go`, `ExpectedCashFlow`, `Service`, `WriteHTTPError`, `Handler`, `ExactAmount`, `ProfitLossHandler`, `Money`, `Service`, `Handler`, `Must`, `Context`, `NewRouter`, `Handler`, `NewAdapter`, `audit/service_test.go`, `ConnectionStatus`, `Adapter`, `midtransiris/adapter.go`, `ContractService`, `numericToMoney`, `MustDecimal`, `Handler`, `ConsolBalanceByTypeQueryRow`, `Handler`, `import.go`, `Service`, `ContractRepository`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `.DecideDecision`, `Handler`, `runFXCommand`, `Handler`, `Handler`, `contracts_domain.go`, `OutboxCommand`, `setupTestDB`, `Handler`, `fx_backfill.go`, `Connection`, `Service`, `NewFXOpsCLI`, `inventory/domain.go`, `Service`, `midtrans/client.go`?**
  _High betweenness centrality (0.191) - this node is a cross-community bridge._
- **Why does `main()` connect `main` to `BatchExecutionEnqueuer`, `service_bs.go`, `NewOperationsService`, `CSRFManager`, `Exporter`, `ApprovalRecorder`, `AuditLogger`, `BalanceSheetHandler`, `PayslipProcessor`, `DebitNotePDFRenderer`, `PermissionsHandler`, `IdempotencyStore`, `CreditNotePDFRenderer`, `ReturnDeliveryInfo`, `SourcingService`, `freight/repository.go`, `AsynqOptions`, `ExpectedCashFlow`, `NewMockRepository`, `WalkRoutes`, `logisticsDistributionGateway`, `NewRegistry`, `NewRouter`, `ConnectionStatus`, `NewPostgresStore`, `Settings`, `odyssey/main.go`, `settlementServiceFixture`, `OutboxMessage`, `ap_invoice.go`, `runtime.go`, `Vault`, `forecasting/service.go`, `LoadConfig`, `NewSessionManager`, `Settlement`, `PaymentOperation`, `NewOperationsHandler`, `runFXCommand`, `Hooks`, `setupTestDB`, `SourcingRepository`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `SessionFromContext()` connect `SessionFromContext` to `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `MiddlewareStack`, `Handler`, `Handler`, `Handler`, `CSRFManager`, `Handler`, `Handler`, `Handler`, `BalanceSheetHandler`, `Handler`, `Handler`, `WriteErrorStatus`, `Handler`, `PermissionsHandler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `.New`, `WriteHTTPError`, `Handler`, `ProfitLossHandler`, `Handler`, `Handler`, `NewRouter`, `Handler`, `PermissionChecker`, `Handler`, `Handler`, `Handler`, `IdentityFromContext`, `OperationsHandler`, `JSONResponse`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `main`, `Handler`, `Handler`, `Handler`, `Middleware`, `Handler`, `Handler`, `ContextWithSession`, `Handler`, `Handler`?**
...
- **Should `models.go` be split into smaller, more focused modules?**
  _Cohesion score 0.01849680170575693 - nodes in this community are weakly interconnected._
