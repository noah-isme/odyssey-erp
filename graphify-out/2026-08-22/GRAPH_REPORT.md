...
## Summary
- 19313 nodes · 39954 edges · 1342 communities (1236 shown, 106 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 2505 edges (avg confidence: 0.78)
...
- .MountRoutes
- .MountRoutes
- TestOperationsHandlerRecoveryUsesPRG
- runFXCommand
...
- `main()` --calls--> `LoadConfig()`  [INFERRED]
  cmd/odyssey/main.go → internal/app/config.go
- `main()` --calls--> `NewDistributionHandler()`  [INFERRED]
  cmd/odyssey/main.go → internal/app/distribution.go
- `main()` --calls--> `NewLogger()`  [INFERRED]
  cmd/odyssey/main.go → internal/app/logger.go

## Import Cycles
- None detected.

## Communities (1342 total, 106 thin omitted)
...
Cohesion: 0.14
Nodes (25): warehouses, inventory_stock_take_lines, inventory_stock_takes, inventory_adjustment_lines, inventory_adjustments, mrp_planning_recommendations, mrp_planning_runs, mrp_product_planning_policies (+17 more)
...
### Community 9 - "Context"
Cohesion: 0.08
Nodes (36): pgTxRepository, Repository, TxRepository, apPaymentSourceID(), dateToTime(), decimalScale(), decimalToNumeric(), floatToNumeric() (+28 more)
...
Cohesion: 0.09
Nodes (31): inventory_balances, inventory_serials, inventory_lots, mrp_work_orders, mrp_production_events, mrp_routing_operations, mrp_routings, mrp_work_centers (+23 more)
...
### Community 21 - "Cache"
Cohesion: 0.13
Nodes (13): Cache, CacheEntry, contextKey, PerformanceMonitor, QueryOptimizations, CacheFromContext(), ContextWithCache(), Context (+5 more)
...
Cohesion: 0.09
Nodes (27): ARAgingBucket, ARAgingDetail, ARCreditNoteAllocation, ARInvoice, ARInvoiceLine, ARInvoiceStatus, ARInvoiceWithDetails, ARPayment (+19 more)
...
Cohesion: 0.08
Nodes (17): UpdateDocumentRequest, Context, DispositionRequest, Document, DocumentCategory, DocumentClassification, DocumentLink, DocumentNumberingRule (+9 more)
...
### Community 39 - "ExactAmount"
Cohesion: 0.07
Nodes (46): ExactAmount, firstNonEmptyExact(), Money, hasExactAmount(), isZeroExactAmount(), isZeroReference(), validateSettlementAmount(), Context (+38 more)
...
### Community 42 - "ExternalReference"
Cohesion: 0.06
Nodes (39): ConnectionRef, ExternalReference, Account, Balance, fakeFeed, InboundEvent, SyncRequest, Transaction (+31 more)

### Community 43 - "Repository"
Cohesion: 0.06
Nodes (17): DocumentAccessEvent, CreateBlobRequest, CreateLinkRequest, DocumentCollaborationSession, ExpiredRetention, Repository, Context, DispositionRequest (+9 more)
...
Cohesion: 0.19
Nodes (14): Context, Document, DocumentVersion, Engine, Pool, Reader, Request, ResponseWriter (+6 more)
...
Cohesion: 0.07
Nodes (33): CalibrationRequestedPayload, NormaliseStatus(), currentCompany(), currentUser(), Engine, Handler, Logger, Pool (+25 more)
...
Cohesion: 0.09
Nodes (29): database, Repository, Settings, SettingsService, SettingsStore, settingsStoreFake, Context, T (+21 more)

### Community 62 - "odyssey/main.go"
Cohesion: 0.09
Nodes (21): BarOpts, Client, Context, Logger, Pool, Service, Time, Email (+13 more)

### Community 63 - "Context"
Cohesion: 0.14
Nodes (17): Context, DeliveryOrder, Int8, Repository, TxRepository, Pool, Queries, ReturnDeliveryOrder (+9 more)
...
Cohesion: 0.31
Nodes (10): Handler, Request, ResponseWriter, Router, pathID(), requestScope(), respondClientError(), respondError() (+2 more)

### Community 75 - "users"
Cohesion: 0.06
Nodes (59): audit_logs, permissions, role_permissions, roles, sessions, user_roles, users, accounting_periods (+51 more)
...
Cohesion: 0.12
Nodes (37): allExported(), allowedTransition(), cloneExecution(), Context, Instruction, Mutex, Coordinator, Instruction (+29 more)
...
Cohesion: 0.09
Nodes (26): journalPosterFake, ledgerCapture, Time, UUID, defaultReversalMemo(), Context, JournalEntry, JournalLine (+18 more)
...
### Community 90 - "Task"
Cohesion: 0.05
Nodes (31): Context, Context, Logger, HandleCMMSPMGeneratorScanTask(), T, TestHandleCMMSPMGeneratorScanTask(), CMMSPMGeneratorService, Context (+23 more)
...
Cohesion: 0.09
Nodes (29): Engine, Logger, Pool, Router, Service, MountRoutes(), T, TestMountRoutesBuildsDeliveryOrderRoutes() (+21 more)
...
Cohesion: 0.17
Nodes (14): BuildDeliverableMap(), ToDetailResponse(), ToListResponse(), Time, DeliveryOrder, DetailResponse, Line, LineWithDetails (+6 more)

### Community 99 - ".processRows"
Cohesion: 0.19
...
### Community 103 - "UUID"
Cohesion: 0.06
Nodes (37): Bool, Int4, Time, UUID, Approval, ApprovalPolicyStep, AuditEvent, BankTransaction (+29 more)
...
Cohesion: 0.14
Nodes (35): approvedCoordinator(), Context, Coordinator, Instruction, Submission, T, paymentInstruction(), providerReference() (+27 more)
...
Cohesion: 0.07
Nodes (28): accountingFake, ARCreditNote, ARCreditNoteLine, ARCreditNoteStatus, ARCreditNoteWithDetails, CreateARCreditNoteFromReturnInput, creditNoteMemoryRepo, CreditNoteRepositoryPort (+20 more)
...
Cohesion: 0.14
Nodes (19): CostCenterType, CostCenterUpdate, CreateCostCenterInput, postgresRepository, Context, CostCenter, FreightCharge, Int8 (+11 more)
...
Cohesion: 0.09
Nodes (17): plPDFExporter, plPDFRenderer, ProfitLossHandler, stubPLPDFExporter, Engine, Handler, Logger, Router (+9 more)

### Community 172 - "notifications/dispatcher.go"
Cohesion: 0.12
Nodes (25): Context, Context, ApprovalRequested(), Context, Service, InvoiceIssued(), NewDispatcher(), PasswordReset() (+17 more)
...
Cohesion: 0.07
Nodes (27): APAgingBucket, APAllocationValuation, APInvoiceValuation, APPaymentValuation, AuditPort, FXRateResolver, LedgerPostError, PostAPInvoiceInput (+19 more)
...
Cohesion: 0.13
Nodes (28): CreateRateSurchargeInput, FreightChargeFilter, FreightChargeStatus, FreightChargeUpdate, LandedCostFilter, RateCardFilter, RateCardUpdate, RateLookup (+20 more)
...
Cohesion: 0.04
Nodes (63): branches, companies, cost_centers, departments, report_schedules, report_schedule_deliveries, mrp_audit_events, mrp_controlled_record_policies (+55 more)

### Community 188 - "midtransiris/adapter.go"
Cohesion: 0.07
Nodes (72): ErrorCategory, biSnapStatus(), biSnapSuccess(), categoryForTransport(), classifyProviderResponse(), decodeBISNAPResponse(), exactAmount(), firstNonEmpty() (+64 more)
...
Cohesion: 0.11
Nodes (18): arNotificationPrefs, arNotificationsStore, arPermissionReader, CreditNotePDFClient, creditNotePDFFake, CreditNotePDFRenderer, Handler, Context (+10 more)

### Community 191 - "Context"
Cohesion: 0.15
Nodes (6): Context, Customer, QuotationLine, SalesOrder, Queries, GetCustomerByCodeParams

### Community 192 - "Context"
Cohesion: 0.12
Nodes (16): Context, JournalEntry, JournalLine, JournalStatus, Period, T, Time, TxRepository (+8 more)
...
Cohesion: 0.16
Nodes (20): firstNonBlank(), Context, Time, MaskName(), MaskSensitive(), NewOperationsRepository(), TestOperationsMaskHelpers(), validOperationState() (+12 more)
...
Cohesion: 0.19
Nodes (23): Context, Decimal, FXQuote, Int8, NewTreasurySettlementEffects(), NewTreasurySettlementEffectsWithFXResolver(), nullableInt8(), postAPRealizedFXJournal() (+15 more)
...
### Community 241 - "documents/repository.go"
Cohesion: 0.10
Nodes (12): CreateCategoryRequest, CreateLegalHoldRequest, derefInt64(), Int8, LegalHold, Pool, Text, int64Ptr() (+4 more)
...
Cohesion: 0.13
Nodes (25): DefaultPaymentRecoveryScanConfig(), financeRecoveryMessage(), Context, Duration, Time, metricProvider(), NewPaymentRecoveryRepository(), NewPaymentRecoveryScanner() (+17 more)
...
Cohesion: 0.28
Nodes (16): AllocationMethod, AuditType, CalculateFreightInput, CalculateFreightOutput, CalculateLandedCostInput, CostCenter, CreateRateCardInput, FreightAuditLog (+8 more)
...
### Community 273 - "BuildTrialBalance"
Cohesion: 0.17
...
Cohesion: 0.08
Nodes (27): BalanceSheetHandler, bsPDFExporter, stubBSPDFExporter, Duration, observeVMBuildDuration(), recordCacheHit(), recordCacheMiss(), Engine (+19 more)
...
Cohesion: 0.12
Nodes (26): AdminHandler, RouterParams, workspaceCompany, workspaceUser, Config, Dispatcher, activeCompanyMiddleware(), Context (+18 more)
...
Cohesion: 0.32
Nodes (15): NewAdapter(), fixtureResponse(), Instruction, Request, Response, T, TestBISNAPAccessTokenAndTransactionalSignature(), TestBISNAPLookupAndCancelUseDurableProviderAndInstructionReferences() (+7 more)
...
Cohesion: 0.14
Nodes (18): AccountingJournalPoster, freightPostingKey, FreightToGLEntry, GLPostingService, PostFreightToGLInput, BuildFreightGLEntries(), freightSourceID(), Context (+10 more)

### Community 336 - "fakeShipmentGateway"
Cohesion: 0.11
...
Cohesion: 0.09
Nodes (9): CounterVec, GaugeVec, HistogramVec, Duration, NewPaymentRecoveryMetrics(), T, TestPaymentRecoveryMetricsExposeRecoverySignals(), PaymentRecoveryMetrics (+1 more)

### Community 340 - "Status"
Cohesion: 0.17
Nodes (7): CreateDocumentRequest, CreateVersionRequest, Document, DocumentVersion, ListFilter, Status, statusStringOrEmpty()
...
Cohesion: 0.10
Nodes (26): Context, Client, TaskInfo, NewBankFeedsEventTask(), BoardPackPayload, CRMReminderDispatcher, FinanceAutomationDispatcher, InsightsWarmupPayload (+18 more)
...
Cohesion: 0.36
Nodes (4): Context, Channels, preferenceFake, preferenceMatrixFake

### Community 393 - "certification_test.go"
Cohesion: 0.19
Nodes (31): DB, Header, Reader, evidenceRecord, evidenceReporter, httpResult, stagingClient, stagingConfig (+23 more)
...
### Community 412 - "InvoicingAdapter"
Cohesion: 0.43
Nodes (4): Context, Pool, NewInvoicingAdapter(), InvoicingAdapter
...
Cohesion: 0.29
Nodes (11): Service, Repository, NewFreightService(), T, moneyToStrPtr(), TestCalculateFreightCharge_BasicCalculation(), TestCostCenterCreation(), TestRateCardValidation_WeightBounds() (+3 more)
...
### Community 443 - "sales.sql.go"
Cohesion: 0.26
Nodes (20): Bool, Date, Int8, Numeric, QuotationStatus, SalesOrderStatus, Text, Timestamptz (+12 more)
...
### Community 448 - ".Bars"
Cohesion: 0.18
Nodes (8): a, HTML, T, TestBarsProducesSVG(), T, TestLineProducesSVG(), BarOpts, LineOpts
...
Cohesion: 0.23
Nodes (10): CSRFManager, Engine, Logger, Middleware, Request, ResponseWriter, Router, NewOperationsHandler() (+2 more)
...
Cohesion: 0.27
Nodes (16): MustParseExact(), database, Pool, NewPGSettlementEffects(), NewPGSettlementEffectsWithApplier(), NewPostgresSettlementEffects(), NewPostgresSettlementEffectsWithApplier(), T (+8 more)
...
### Community 477 - "Cache"
Cohesion: 0.19
Nodes (12): Cache, Client, Context, Duration, NewCache(), Repository, Service, T (+4 more)
...
Cohesion: 0.24
Nodes (8): StatementArtifact, StatementTransport, statementTransportFake, Service, Context, Time, Context, validateStatementArtifact()
...
Cohesion: 0.13
Nodes (15): Context, NewPayslipProcessor(), Context, T, TestPayslipWorkerRendersAndEmailsPDF(), Context, mailerFake, PayslipMailer (+7 more)
...
Cohesion: 0.43
Nodes (14): TestPostInvoiceDispatchesNotification(), NewService(), T, newMemoryARRepo(), TestCalculateARAging(), TestCreateARInvoice(), TestCreateARInvoiceRequiresCustomerID(), TestCreateARInvoiceRequiresPositiveTotal() (+6 more)
...
### Community 589 - "sourcing_domain.go"
Cohesion: 0.16
...
### Community 615 - "TestOperationsHandlerRecoveryUsesPRG"
Cohesion: 0.39
Nodes (8): Context, Request, T, operationsRequestContext(), TestOperationsHandlerListRendersMaskedOperation(), TestOperationsHandlerListRequiresTenantIdentity(), TestOperationsHandlerRecoveryUsesPRG(), withOperationsParams()
...
Cohesion: 0.04
Nodes (43): Architecture Decision Records, Creating a New ADR, Domain-Specific ADRs, Foundational ADRs, Naming Conventions, Template, ADR-0001: Pemilihan Tooling Inti, Keputusan (+35 more)
...
Cohesion: 0.08
Nodes (36): Decimal, FXQuote, FXQuoteSet, PaymentValuation, RateRepository, Resolver, RevaluationInput, RevaluationResult (+28 more)
...
### Community 999 - "BankFeedsProcessor"
Cohesion: 0.43
Nodes (6): Logger, Service, NewBankFeedsProcessor(), BankFeedsEventPayload, BankFeedsProcessor, BankFeedsSyncPayload

### Community 1000 - "NewHooks"
Cohesion: 0.16
Nodes (15): AccountMappingRepository, Ledger, mappingFake, periodFake, PeriodRepository, TransactionalLedger, AccountMapping, Context (+7 more)

### Community 1001 - "memoryRepo"
Cohesion: 0.20
...
Cohesion: 0.07
Nodes (31): Handler, Engine, Logger, Request, ResponseWriter, Router, Service, identity() (+23 more)
...
Cohesion: 0.14
Nodes (11): CreateACLRequest, CreateDispositionRequest, ReviewDecisionRequest, DocumentReviewDecision, valueOrZero(), Context, DispositionRequest, Service (+3 more)

### Community 1054 - "SQLRepository"
Cohesion: 0.15
Nodes (12): FetchRun, Operations, RateStatus, Context, Service, SQLRepository, Time, Context (+4 more)
...
### Community 1077 - "AdminHandler"
Cohesion: 0.26
Nodes (8): AdminHandler, Engine, Logger, Request, ResponseWriter, Router, Service, NewAdminHandler()
...
### Community 1087 - "CreateQuotationRequest"
Cohesion: 0.29
...
### Community 1129 - "PostgresSettlementResultStore"
Cohesion: 0.36
...
### Community 1136 - "NewMockRepository"
Cohesion: 0.50
Nodes (11): NewGLPostingService(), freightTestCharge(), freightTestInput(), T, TestPostFreightToGLFailsClosedWithoutAccounting(), TestPostFreightToGLIsIdempotentForExistingSourceLink(), TestPostFreightToGLPostsBalancedExactJournalWithDimensions(), TestPostFreightToGLPropagatesAccountingError() (+3 more)
...
Cohesion: 0.24
Nodes (10): HandlerFunc, HandleFinancePaymentRecoveryScan(), NewFinancePaymentRecoveryTask(), T, TestHandleFinancePaymentRecoveryScanInvokesScanner(), TestHandleFinancePaymentRecoveryScanPropagatesError(), TestHandleFinancePaymentRecoveryScanSkipsWhenUnconfigured(), FinancePaymentRecoveryScanner (+2 more)

### Community 1150 - "Job"
Cohesion: 0.38
Nodes (8): Job, JobConfig, Dispatcher, Logger, Service, Storage, NewJob(), Renderer

### Community 1151 - "pointerToText"
Cohesion: 0.23
Nodes (8): floatToNumeric(), Numeric, Text, pointerToText(), Context, DeliveryOrder, txRepository, Status

### Community 1152 - "HandleFXDailyRatesTask"
Cohesion: 0.13
...
Cohesion: 0.22
Nodes (9): Alerts and issue resolution, Dead-letter recovery, Durable evidence, Local acceptance, Metrics and health checks, Payment Connector Recovery Runbook, Refund recovery, Runtime contract (+1 more)
...
### Community 1170 - "cache.go"
Cohesion: 0.19
Nodes (14): Repository, Cache, Time, keyAging(), keyCashflow(), keyKPI(), keyPLTrend(), Service (+6 more)
...
### Community 1229 - "calculateComparison"
Cohesion: 0.23
...
### Community 1259 - "v0.11-finance Sandbox Certification Record"
Cohesion: 0.33
Nodes (6): Candidate and environment identity, Evidence rules, Findings and approval, Local and sandbox commands, Required evidence registry, v0.11-finance Sandbox Certification Record

### Community 1260 - ".CreateCollaborationSession"
Cohesion: 0.47
...
### Community 1277 - "Point of Sale (POS)"
Cohesion: 0.50
...
### Community 1280 - "ReturnStatus"
Cohesion: 0.18
Nodes (5): T, TestDeliveryStatusLifecycleRules(), TestReturnStatusLifecycleRules(), ListReturnRequest, ReturnStatus

### Community 1282 - "Documentation Status"
Cohesion: 0.67
Nodes (3): Available Documentation ✅, Documentation Status, Phase 9 Documentation ✅

### Community 1283 - "Projects and Timesheets"
Cohesion: 0.50
...
### Community 1285 - "Supply Chain Management"
Cohesion: 0.50
...
### Community 1290 - "Warehouse Management System (WMS)"
Cohesion: 0.50
...
### Community 1295 - "Cross-Module Lifecycle Reference"
Cohesion: 0.67
Nodes (3): Cross-Module Lifecycle Reference, Explicitly not covered, Module notes

### Community 1296 - "ADR-0009: Asset capitalization and operations"
Cohesion: 0.67
...
### Community 1313 - ".CreateBid"
Cohesion: 0.42
Nodes (7): canonicalDecimal(), compareDecimal(), Money, lessOrEqualDecimal(), nonNegativeDecimal(), positiveDecimal(), validateMoney()
...
### Community 1322 - "Service"
Cohesion: 0.39
Nodes (5): FXProvider, Service, Context, Duration, Time

### Community 1323 - "KPIFilter"
Cohesion: 0.33
Nodes (5): KPIFilter, KPISummary, Service, Context, Time

### Community 1324 - "NewService"
Cohesion: 0.33
Nodes (6): Repository, Storage, NewService(), T, TestNormaliseStatus(), TestServiceRejectsInvalidRequestsWithoutRepository()

### Community 1325 - "NewAsynqRFQEmailQueue"
Cohesion: 0.33
Nodes (5): Client, Context, NewAsynqRFQEmailQueue(), asynqRFQEmailQueue, RFQEmailQueue

### Community 1326 - "ListSalesOrdersRequest"
Cohesion: 0.48
...
### Community 1327 - "TestForecastHandlerRejectsMissingIdentifiers"
Cohesion: 0.53
...
### Community 1330 - "transport_test.go"
Cohesion: 0.60
Nodes (4): T, TestSyncStatementTransportDerivesMissingChecksum(), TestSyncStatementTransportUsesManualImportParserAndChecksum(), TestValidateStatementArtifactRejectsTampering()

### Community 1331 - "jobsTemplates"
Cohesion: 0.50
Nodes (3): Engine, ResponseWriter, jobsTemplates

### Community 1332 - "Quick Start"
Cohesion: 0.50
Nodes (4): Prerequisites, Quick Start, Start Odyssey, Verify and stop

### Community 1334 - "NewRepository"
Cohesion: 0.50
...
## Knowledge Gaps
- **3046 isolated node(s):** `resultOperationReader`, `FLASH_KIND_TO_TOAST_VARIANT`, `Deployment contract`, `VPS layout`, `Systemd services` (+3041 more)
...
- `SessionFromContext()` (2× useful, score=1.470253459)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Parse()` connect `Parse` to `BatchExecutionEnqueuer`, `Handler`, `distribution/handler.go`, `Handler`, `Context`, `Handler`, `CSRFManager`, `certification_test.go`, `Handler`, `CoretaxService`, `Handler`, `PermissionsHandler`, `distribution/repository.go`, `SignatureChallengeService`, `Context`, `regression_test.go`, `Service`, `UserSafeMessage`, `ParseCSV`, `Context`, `.CreateBid`, `ExpectedCashFlow`, `Service`, `.New`, `Handler`, `Handler`, `Money`, `BalanceSheetHandler`, `Must`, `Service`, `Handler`, `NewRouter`, `numericToMoney`, `PGRepository`, `Handler`, `NewAdapter`, `audit/service_test.go`, `ConnectionStatus`, `freight/repository.go`, `Adapter`, `midtransiris/adapter.go`, `ContractService`, `SessionFromContext`, `Service`, `Context`, `.processRows`, `Handler`, `Decimal`, `import.go`, `Service`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `.DecideDecision`, `Handler`, `contracts_domain.go`, `.processRows`, `runFXCommand`, `Handler`, `Handler`, `ContractRepository`, `OutboxCommand`, `setupTestDB`, `Handler`, `fx_backfill.go`, `Connection`, `Service`, `NewFXOpsCLI`, `inventory/domain.go`, `midtrans/client.go`?**
  _High betweenness centrality (0.220) - this node is a cross-community bridge._
- **Why does `main()` connect `main` to `BatchExecutionEnqueuer`, `NewOperationsService`, `IdempotencyStore`, `Exporter`, `ApprovalRecorder`, `AuditLogger`, `PayslipProcessor`, `DebitNotePDFRenderer`, `PermissionsHandler`, `SourcingService`, `InvoicingAdapter`, `AsynqOptions`, `ExpectedCashFlow`, `NewFreightService`, `WalkRoutes`, `ExternalReference`, `logisticsDistributionGateway`, `NewRegistry`, `BalanceSheetHandler`, `NewAsynqRFQEmailQueue`, `NewRouter`, `AdminHandler`, `freight/repository.go`, `Handler`, `ConnectionStatus`, `NewPostgresStore`, `Settings`, `Context`, `odyssey/main.go`, `OutboxMessage`, `OperationsHandler`, `coordinator.go`, `ap_invoice.go`, `runtime.go`, `Vault`, `forecasting/service.go`, `LoadConfig`, `.processRows`, `PaymentOperation`, `runFXCommand`, `NewHooks`, `TestTreasuryHandlersUseTenantIdentityAndImplementFlows`, `setupTestDB`, `SourcingRepository`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `SessionFromContext()` connect `SessionFromContext` to `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `MiddlewareStack`, `Handler`, `Handler`, `CSRFManager`, `WriteHTTPError`, `Handler`, `Handler`, `Handler`, `Handler`, `WriteErrorStatus`, `Handler`, `ContextWithSession`, `PermissionsHandler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `UserSafeMessage`, `Handler`, `.New`, `Handler`, `Handler`, `BalanceSheetHandler`, `Handler`, `Handler`, `NewRouter`, `Handler`, `PermissionChecker`, `AdminHandler`, `Handler`, `Handler`, `IdentityFromContext`, `OperationsHandler`, `JSONResponse`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `main`, `Handler`, `Handler`, `Handler`, `Middleware`, `Handler`, `Handler`, `Handler`, `Handler`?**
...
- **What connects `resultOperationReader`, `FLASH_KIND_TO_TOAST_VARIANT`, `Deployment contract` to the rest of the system?**
...
- **Should `models.go` be split into smaller, more focused modules?**
  _Cohesion score 0.0186546791395188 - nodes in this community are weakly interconnected._
