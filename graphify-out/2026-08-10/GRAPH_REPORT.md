# Graph Report - /home/noah/project/odyssey-erp  (2026-08-10)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 17798 nodes · 36160 edges · 1245 communities (1159 shown, 86 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 2113 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4a243b8e`
...
- 000082_shared_foundations.up.sql
...
- TestPercentageDifferenceUsesExactPriceMath
...
- TestFlashPersistsAcrossRedirectAndClearsAfterRead

## God Nodes (most connected - your core abstractions)
1. `companies` - 194 edges
2. `SessionFromContext()` - 179 edges
3. `users` - 167 edges
4. `UserSafeMessage()` - 149 edges
5. `Parse()` - 128 edges
6. `WriteErrorStatus()` - 108 edges
7. `CSRFManager` - 97 edges
8. `Middleware` - 92 edges
9. `Connection` - 85 edges
10. `Handler` - 74 edges
...
## Communities (1245 total, 86 thin omitted)

### Community 0 - "models.go"
Cohesion: 0.02
Nodes (326): Date, Float8, Int8, Numeric, Text, Timestamp, Timestamptz, AccountMap (+318 more)
...
### Community 3 - ".Scan"
Cohesion: 0.03
Nodes (41): Account, AccountType, ArCreditNote, ArCreditNoteStatus, BankLineStatus, BankStatement, BankStatementLine, BankStatementStatus (+33 more)
...
### Community 5 - "Context"
Cohesion: 0.10
Nodes (14): ARAllocationValuation, ARInvoiceValuation, ARPaymentValuation, txRepo, TxRepository, decimalScale(), Repository, Context (+6 more)
...
### Community 9 - "Context"
Cohesion: 0.06
Nodes (47): APAllocationValuation, APInvoiceBalance, APInvoiceValuation, APPaymentValuation, MatchingPolicy, MatchingRun, MatchingRunLine, pgTxRepository (+39 more)
...
Cohesion: 0.07
Nodes (59): branches, companies, warehouses, api_key_scopes, api_keys, horizon_idempotency_keys, mrp_bom_lines, mrp_boms (+51 more)
...
Cohesion: 0.07
Nodes (36): ListAssetsFilter, PreventiveMaintenanceSchedule, Repository, Asset, Context, Location, MeterReading, Pool (+28 more)

### Community 14 - "mrp_work_order_operations"
Cohesion: 0.09
Nodes (30): inventory_serials, inventory_lots, mrp_work_orders, mrp_production_events, mrp_routing_operations, mrp_routings, mrp_work_centers, mrp_material_movements (+22 more)

### Community 15 - "Context"
Cohesion: 0.08
Nodes (23): memoryAPRepo, memoryAPTx, taxPortFake, APPaymentAllocation, NewService(), fmtInt(), APInvoice, APInvoiceStatus (+15 more)

### Community 16 - "ARCreditNote"
Cohesion: 0.06
Nodes (30): accountingFake, ARCreditNote, ARCreditNoteLine, ARCreditNoteStatus, ARCreditNoteWithDetails, CreateARCreditNoteFromReturnInput, CreateARCreditNoteInput, CreateARCreditNoteLineInput (+22 more)

### Community 17 - "WriteErrorStatus"
Cohesion: 0.13
Nodes (12): Engine, ExceptionService, Pool, Repository, Request, ResponseWriter, WorkOrder, ids() (+4 more)
...
### Community 19 - "forecasting/service.go"
Cohesion: 0.09
Nodes (33): BaseCurrencyReader, CreateForecastDailyBucketInput, CreateForecastRunInput, CreateForecastSourceLineInput, dailyFlow, ForecastDailyBucket, forecastReaderFake, forecastRepoFake (+25 more)
...
Cohesion: 0.12
Nodes (18): Context, Date, ForecastDailyBucket, ForecastRun, Int8, Numeric, Queries, Text (+10 more)
...
### Community 39 - "Task"
Cohesion: 0.06
Nodes (32): Context, Logger, Service, NewBankFeedsEventTask(), NewBankFeedsProcessor(), BankFeedsEventPayload, BankFeedsProcessor, BankFeedsSyncPayload (+24 more)
...
Cohesion: 0.09
Nodes (28): Repository, AccountBalance, BoardPack, Company, Context, CreateRequest, Int4, Int8 (+20 more)
...
### Community 56 - "ap/domain.go"
Cohesion: 0.07
Nodes (40): APAgingBucket, APAgingDetail, APInvoice, APInvoiceLine, APInvoiceStatus, APInvoiceWithDetails, APPayment, APPaymentAllocation (+32 more)

### Community 57 - "storeFake"
Cohesion: 0.13
Nodes (11): Activity, ActivityInput, customerFake, notifierFake, Pipeline, Stage, storeFake, Context (+3 more)
...
Cohesion: 0.11
Nodes (16): Client, Context, Engine, Logger, Pool, ResponseWriter, Service, Time (+8 more)
...
Cohesion: 0.12
Nodes (16): coalesceInt64(), Context, Driver, StopType, Timestamptz, TripStop, Vehicle, mapDriver() (+8 more)

### Community 66 - "products"
Cohesion: 0.07
Nodes (61): categories, customers, products, suppliers, taxes, units, ap_invoices, ap_payments (+53 more)

### Community 67 - "MockRepository"
Cohesion: 0.14
Nodes (9): MockRepository, Context, CostCenter, CreateCostCenterInput, CreateRateCardInput, FreightCharge, LandedCost, RateCard (+1 more)
...
Cohesion: 0.09
Nodes (12): fakeDistributionRepository, Context, DeliveryRoute, Load, LoadItem, Money, PlanningHorizon, PlanningRule (+4 more)
...
Cohesion: 0.12
Nodes (22): Time, UUID, defaultReversalMemo(), Context, JournalEntry, JournalLine, Repository, Time (+14 more)
...
Cohesion: 0.12
Nodes (19): Lead, Opportunity, Repository, duplicateContact(), Context, Event, Pool, Time (+11 more)
...
Cohesion: 0.12
Nodes (29): Asset, AssetSpecification, CreateAssetRequest, CreateWorkOrderRequest, IoTReading, IoTSensor, ListWorkOrdersFilter, Location (+21 more)
...
### Community 106 - "procurement/domain.go"
Cohesion: 0.14
...
Cohesion: 0.17
Nodes (15): ContractPriceLine, Money, Time, ApprovalStatus, ContractPriceLine, ContractStatus, CreatePOVarianceInput, CreateScorecardInput (+7 more)
...
### Community 111 - "Hooks"
Cohesion: 0.13
Nodes (21): AccountMappingRepository, ConnectorsService, Ledger, PeriodRepository, TransactionalLedger, Context, Hooks, Tx (+13 more)
...
Cohesion: 0.10
Nodes (26): Context, Date, Int8, PeriodStatus, Queries, Text, Timestamptz, InsertAccountingPeriodParams (+18 more)
...
Cohesion: 0.08
Nodes (48): CostCenterType, CostCenterUpdate, CreateCostCenterInput, CreateRateSurchargeInput, FreightChargeFilter, FreightChargeStatus, FreightChargeUpdate, LandedCostFilter (+40 more)

### Community 120 - "stubCloseService"
Cohesion: 0.20
...
### Community 122 - "mockRepo"
Cohesion: 0.08
Nodes (21): MatchingService, mockRepo, Orchestrator, POLineProgress, Context, Repository, NewMatchingService(), Context (+13 more)
...
Cohesion: 0.10
Nodes (3): ADR-0005: Transaction-level FX, Odyssey ERP Module Catalog, Reporting Catalog
...
Cohesion: 0.11
Nodes (19): Dependencies, fakeInventoryGateway, fakeShipmentGateway, InventoryAdjustmentInput, InventoryGateway, ShipmentCreateInput, ShipmentGateway, ShipmentLine (+11 more)
...
Cohesion: 0.17
Nodes (15): ConnectionReader, Handler, loginForm, loginPageData, Context, Engine, Logger, Provider (+7 more)
...
### Community 145 - "ContractRepository"
Cohesion: 0.11
Nodes (15): Context, ContractPriceLine, Money, Pool, SupplierContract, SupplierScorecard, Time, scanPOContractVariance() (+7 more)
...
Cohesion: 0.14
Nodes (16): apPermissionReader, DebitNotePDFClient, debitNotePDFFake, DebitNotePDFRenderer, Handler, Context, Request, ResponseWriter (+8 more)
...
### Community 152 - "Vault"
Cohesion: 0.09
Nodes (19): Adapter, Credentials, ExportPayload, roundTripFunc, Client, Context, Logger, NewAdapter() (+11 more)

### Community 153 - "DistributionRepository"
Cohesion: 0.09
Nodes (17): AddLoadItemInput, AddTransferLineInput, CreatePlanningRuleInput, CreateRouteInput, DistributionRepository, Context, DeliveryRoute, Load (+9 more)

### Community 154 - "Connection"
Cohesion: 0.10
Nodes (17): Connection, ConnectionStatus, registryAdapter, Context, Header(), Context, Logger, NewAdapter() (+9 more)

### Community 155 - "InvoicingAdapter"
Cohesion: 0.31
Nodes (6): DeliveryLineInfo, DeliveryOrderInfo, Context, Pool, NewInvoicingAdapter(), InvoicingAdapter
...
### Community 171 - "distribution/repository.go"
Cohesion: 0.11
Nodes (37): AddRouteStopInput, CreateLoadInput, CreatePlanningHorizonInput, CreateTransferOrderInput, Repository, rowScanner, datePtr(), dateValue() (+29 more)
...
Cohesion: 0.22
Nodes (17): DeliveryRoute, HorizonStatus, Load, LoadItem, LoadStatus, PlanningHorizon, PlanningRule, RouteStatus (+9 more)
...
Cohesion: 0.13
Nodes (16): integrationInventoryGateway, integrationShipmentGateway, ShipmentLineInput, cleanupDistributionFixture(), Context, Pool, Service, ShipmentLine (+8 more)

### Community 191 - "sourcing_domain.go"
Cohesion: 0.18
Nodes (14): Money, Time, AwardLineInput, BidLineInput, ComparisonEntry, ComparisonSnapshot, CreateAwardInput, CreateBidInput (+6 more)
...
Cohesion: 0.20
Nodes (9): BankStatement, BankStatementLine, Repository, Service, TransferRequest, Context, Time, NewService() (+1 more)

### Community 209 - "documents/repository.go"
Cohesion: 0.11
...
Cohesion: 0.26
Nodes (10): Engine, Logger, Request, ResponseWriter, Router, Service, NewHandler(), payrollCompanyID() (+2 more)
...
Cohesion: 0.22
Nodes (16): effects, destroy(), dispatch(), handleClick(), handleGlobalKeydown(), handleKeydown(), init(), mounted (+8 more)
...
### Community 233 - "tasks.go"
Cohesion: 0.10
Nodes (26): Context, Client, TaskInfo, BoardPackPayload, CRMReminderDispatcher, FinanceAutomationDispatcher, InsightsWarmupPayload, PayrollPayslipPayload (+18 more)
...
Cohesion: 0.19
Nodes (9): Context, Pool, Tx, NewSourcingRepository(), Award, AwardStatus, BidStatus, SourcingRepository (+1 more)
...
### Community 257 - "logistics/repository.go"
Cohesion: 0.14
Nodes (23): floatToNumeric(), CarrierRateCard, Date, Money, Numeric, ShipmentLine, Time, mapRateCard() (+15 more)

### Community 258 - "ProfitLossHandler"
Cohesion: 0.05
...
Cohesion: 0.18
Nodes (18): T, TestPayslipConcealsLookupFailureAndAllowsNilRBACService(), NewService(), Request, Submission, T, TestBankCSVRequiresPostedRunAndConcealsNoEmployeeData(), TestPayrollApprovalAndPostingRecordActors() (+10 more)
...
Cohesion: 0.19
Nodes (11): mapSupplierBankAccount(), Context, Logger, Time, int64Ptr(), optionalID(), payableAccount(), timePtr() (+3 more)
...
Cohesion: 0.18
Nodes (14): db, ImportResult, Row, Service, Context, Pool, Reader, Time (+6 more)
...
### Community 291 - "qms/repository.go"
Cohesion: 0.19
...
Cohesion: 0.15
Nodes (17): Certainty, ExpectedCashFlow, MockReader, SourceType, SQLSourceReader, MustParseExact(), Time, Context (+9 more)

### Community 295 - "storage/storage.go"
Cohesion: 0.17
...
### Community 297 - "Must"
Cohesion: 0.27
Nodes (10): Must(), T, TestMoneyArithmeticDoesNotRoundThroughFloat(), Context, Money, ScorecardService, SupplierScorecard, Time (+2 more)
...
### Community 300 - "NewAdapter"
Cohesion: 0.18
Nodes (11): Logger, NewAdapter(), Request, Response, T, TestExecuteCommand_SendWhatsAppInExplicitDevelopmentMode(), TestWhatsAppSignatureAndSendContract(), roundTripFunc (+3 more)

### Community 301 - "PGRepository"
Cohesion: 0.19
Nodes (9): OIDCConnection, PGRepository, Repository, Context, Pool, Queries, Time, User (+1 more)
...
### Community 304 - "000082_shared_foundations.up.sql"
Cohesion: 0.15
Nodes (24): company_module_features, disposition_requests, document_access_events, document_acls, document_categories, document_classifications, document_links, document_numbering_rules (+16 more)
...
### Community 325 - "ContextWithSession"
Cohesion: 0.12
...
Cohesion: 0.20
Nodes (9): ExportRows(), Context, CreateRuleInput, ListFilters, Repository, Rule, Time, NewService() (+1 more)
...
Cohesion: 0.17
Nodes (9): Context, Customer, Quotation, QuotationLine, QuotationStatus, Repository, Time, memoryRepo (+1 more)
...
### Community 342 - "Status"
Cohesion: 0.20
Nodes (6): CreateVersionRequest, Document, DocumentVersion, ListFilter, Status, statusStringOrEmpty()

### Community 343 - "Handler"
Cohesion: 0.14
Nodes (15): Handler, ParsedStatementLine, Renderer, SessionManager, Reader, Time, ParseCSV(), T (+7 more)

### Community 344 - "crm/domain.go"
Cohesion: 0.19
Nodes (12): Conversion, ConvertInput, CreateLeadInput, CustomerGateway, Event, Notifier, QualifyInput, QuotationGateway (+4 more)
...
### Community 354 - "Int8"
Cohesion: 0.12
Nodes (9): Int8, GetDocumentVersionRow, GetLatestDocumentVersionRow, GetNumberingRuleForCategoryParams, InsertDocumentACLParams, InsertDocumentCategoryParams, ReleaseLegalHoldParams, SetCurrentDocumentVersionParams (+1 more)
...
### Community 358 - "ComputeVariance"
Cohesion: 0.28
Nodes (7): ComputeVariance(), exceedsThreshold(), AccountBalance, round2(), T, TestComputeVariance(), AccountBalance

### Community 359 - "variance/repository.go"
Cohesion: 0.20
Nodes (19): float64Ref(), CreateRuleInput, Int8, Rule, Time, Timestamptz, VarianceSnapshot, int8ToPointer() (+11 more)

### Community 360 - "core/store.js"
Cohesion: 0.36
...
### Community 370 - "midtrans/client.go"
Cohesion: 0.24
Nodes (12): apiError(), Context, Response, RetryPolicy, NewClient(), NewClientWithOptions(), Client, CustomerDetails (+4 more)
...
### Community 385 - "Middleware"
Cohesion: 0.06
Nodes (35): Handler, Engine, Logger, Pool, Router, Service, MountRoutes(), T (+27 more)

### Community 386 - "Adapter"
Cohesion: 0.20
...
Cohesion: 0.24
Nodes (9): Context, Pool, Time, NewManufacturingAnalytics(), nullableTime(), Service, NewHandler(), ManufacturingAnalytics (+1 more)
...
Cohesion: 0.13
Nodes (9): Timestamptz, CreateCollaborationChangeParams, CreateCollaborationChangeRow, CreateCollaborationSessionParams, GetDocumentRow, InsertDocumentRetentionParams, InsertDocumentReviewStepParams, UpdateDispositionExecutionParams (+1 more)
...
### Community 399 - "NewFreightService"
Cohesion: 0.29
...
Cohesion: 0.16
Nodes (11): stubVariance, AccountBalance, Context, ListFilters, PeriodView, Pool, Queries, int8FromInt64() (+3 more)

### Community 405 - "KPIFilter"
Cohesion: 0.33
...
### Community 408 - "ar/handler_test.go"
Cohesion: 0.24
Nodes (9): arPermissionReader, creditNotePDFFake, arRequest(), Request, T, TestCreditNotePDFDownloadReturnsPDF(), TestCreditNoteRouteRequiresPermission(), TestPostInvoiceDispatchesNotification() (+1 more)
...
### Community 418 - "NewSessionManager"
Cohesion: 0.23
Nodes (7): Client, Context, Duration, Request, ResponseWriter, NewSessionManager(), SessionManager
...
### Community 426 - "ARInvoice"
Cohesion: 0.07
Nodes (42): ARAgingBucket, ARAgingDetail, ARCreditNoteAllocation, ARInvoice, ARInvoiceLine, ARInvoiceStatus, ARInvoiceWithDetails, ARPayment (+34 more)
...
Cohesion: 0.08
Nodes (33): CanonicalEventInput, ConnectionCreateInput, CreateCheckoutIntentRequest, CreateCheckoutIntentResult, CreateConnectionParams, InboxEvent, InboxEventInput, ObjectMapping (+25 more)

### Community 430 - "Context"
Cohesion: 0.26
Nodes (5): arNotificationPrefs, arNotificationsStore, Context, Notification, Time
...
### Community 436 - "fx_daily_rates_test.go"
Cohesion: 0.27
...
### Community 439 - "Session"
Cohesion: 0.29
Nodes (3): FlashMessage, Session, sessionPayload
...
### Community 445 - "NewService"
Cohesion: 0.29
Nodes (10): T, TestApproveAndRejectRequireSubmittedQuotation(), TestCreateQuotationRejectsBackwardsValidityWindow(), Repository, NewService(), T, newMemoryRepo(), TestCreateQuotation() (+2 more)

### Community 446 - "sourcing_service.go"
Cohesion: 0.17
Nodes (13): Client, Context, NewAsynqRFQEmailQueue(), compareDecimal(), AuditPort, Money, Service, lessOrEqualDecimal() (+5 more)
...
### Community 454 - "Adapter"
Cohesion: 0.17
Nodes (11): Client, Context, Logger, Time, parseTransactionTime(), responseMessage(), Adapter, CheckoutResult (+3 more)
...
### Community 457 - "Int4"
Cohesion: 0.15
Nodes (15): Bool, Int4, Time, ApprovalPolicyStep, DeliveryRoute, Load, MrpWorkCenterShift, MrpWorkOrderOperation (+7 more)

### Community 458 - "crm_opportunities"
Cohesion: 0.42
...
### Community 462 - "CSRFManager"
Cohesion: 0.08
Nodes (30): Handler, Engine, Logger, Request, ResponseWriter, Service, NewHandler(), Engine (+22 more)
...
### Community 465 - "000112_reporting_administration_phase0.up.sql"
Cohesion: 0.25
...
### Community 479 - "Service"
Cohesion: 0.35
Nodes (5): Repository, Service, CreateConnectionParams, Context, NewService()
...
### Community 482 - "documentsRequestWithSession"
Cohesion: 0.53
...
### Community 496 - "TestTreasuryHandlersUseTenantIdentityAndImplementFlows"
Cohesion: 0.39
...
### Community 507 - "HandleReportScheduleScanTask"
Cohesion: 0.25
...
### Community 522 - "authorizedRequest"
Cohesion: 0.33
...
Cohesion: 0.30
Nodes (5): canonicalDecimal(), Context, Request, positiveDecimal(), SourcingService
...
### Community 533 - "calculateComparison"
Cohesion: 0.23
Nodes (10): calculateComparison(), Rat, T, TestCalculateComparisonHandlesZeroPricedBidsWithoutDivisionByZero(), TestCalculateComparisonRanksEachRFQLineWithExactAmounts(), TestSourcingDecimalHelpers(), weightedScore(), DefaultRFQWeights() (+2 more)
...
Cohesion: 0.11
Nodes (25): ProviderOptions, RetryPolicy, T, TestWebhookEventIDExtractsStripePayloadID(), TestWebhookEventIDIsDeterministicWhenProviderIDIsMissing(), TestWebhookEventIDPrefersProviderEventID(), webhookEventID(), DoWithRetry() (+17 more)
...
### Community 552 - "Service"
Cohesion: 0.53
Nodes (3): Context, Quotation, Service
...
### Community 562 - "README.md"
Cohesion: 0.07
Nodes (26): Known limitations and promotion gates, Odyssey ERP v0.10.0-rc.1 — 2026-08-10, Scope, Upgrade and deployment notes, Verification completed, Changes since rc.1, Odyssey ERP v0.10.0-rc.2 — 2026-08-10, Remaining promotion gates (+18 more)

### Community 563 - ".CreateSupplierBankAccount"
Cohesion: 0.22
...
### Community 914 - "HandleCMMSPMGeneratorScanTask"
Cohesion: 0.25
...
### Community 919 - "000081_manufacturing_governance.up.sql"
Cohesion: 0.27
...
Cohesion: 0.08
Nodes (33): HandlerFunc, Location, Logger, Request, ResponseWriter, Router, Server, Service (+25 more)

### Community 933 - "NewHandler"
Cohesion: 0.22
...
### Community 961 - "Snapshot"
Cohesion: 0.27
Nodes (6): Time, CreateRuleInput, ListFilters, Rule, Snapshot, SnapshotRequest
...
Cohesion: 0.05
Nodes (51): AccountingServicePort, AuditPort, DeliveryServicePort, FXRateResolver, RepositoryPort, TaxServicePort, TransactionalAccountingServicePort, TransactionalARPaymentFXJournalPort (+43 more)
...
Cohesion: 0.23
Nodes (29): Credentials, NewAdapter(), encryptedConn(), Logger, M, Request, Response, T (+21 more)

### Community 981 - "Inspection"
Cohesion: 0.53
...
### Community 1004 - "TripStatus"
Cohesion: 0.43
Nodes (3): Trip, mapTrip(), TripStatus

### Community 1005 - "PaymentBatchItem"
Cohesion: 0.33
Nodes (4): mapPaymentBatchItem(), BankFormatEncoder, CSVEncoder, PaymentBatchItem
...
### Community 1035 - ".InsertLegalHold"
Cohesion: 0.29
...
### Community 1045 - "TestPercentageDifferenceUsesExactPriceMath"
Cohesion: 0.60
Nodes (4): T, TestCalculateOverallScoreUsesInputsAndWeights(), TestPercentageDifferenceUsesExactPriceMath(), TestScoreFromCountsIsExactAndHandlesEmptyEvidence()
...
### Community 1087 - "TestPlanMarksPastDueReleaseAndRejectsMissingPolicy"
Cohesion: 0.67
Nodes (3): T, TestPlanMarksPastDueReleaseAndRejectsMissingPolicy(), TestPlanNetsSupplyAppliesSafetyStockAndLotSizing()

### Community 1089 - "mapCarrier"
Cohesion: 0.53
Nodes (3): Carrier, mapCarrier(), CarrierStatus

### Community 1090 - "Phase 2 - Master Data & Organization ✅ COMPLETE (100%)"
Cohesion: 0.50
...
Cohesion: 0.06
Nodes (48): audit_logs, permissions, role_permissions, roles, sessions, user_roles, users, accounting_periods (+40 more)
...
### Community 1136 - "Documentation Status"
Cohesion: 0.67
Nodes (3): Available Documentation ✅, Documentation Status, Phase 9 Documentation ✅

### Community 1137 - "Phase 6 - Security Hardening ✅ COMPLETE (100%)"
Cohesion: 0.67
...
### Community 1156 - "000075_mrp_compliance_controls.up.sql"
Cohesion: 0.40
...
### Community 1157 - "service_pl_test.go"
Cohesion: 0.70
...
### Community 1222 - "Testing Runbook"
Cohesion: 0.40
...
Cohesion: 0.40
Nodes (5): Adding a New Provider, AR Payment Auto-Allocation via Connector Events, Integration Boundaries, Provider credential payloads, Runtime safety
...
### Community 1251 - "ComputeElimination"
Cohesion: 0.47
Nodes (4): ComputeElimination(), round2(), T, TestComputeElimination()

### Community 1255 - "CreateQuotationRequest"
Cohesion: 0.29
Nodes (8): quotationFake, Quotation, QuotationStatus, Time, CreateQuotationLineReq, CreateQuotationRequest, ListQuotationsRequest, UpdateQuotationRequest
...
### Community 1276 - "Authoritative Feature Matrix"
Cohesion: 0.67
Nodes (3): Authoritative Feature Matrix, Release interpretation, Status definitions

## Knowledge Gaps
- **2840 isolated node(s):** `FXOpsCLI`, `FXOpsCLI`, `github.com/odyssey-erp/odyssey-erp`, `Handler`, `Asset` (+2835 more)
...
- `SessionFromContext()` (2× useful, score=1.969855897)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Parse()` connect `Parse` to `logistics/repository.go`, `ProfitLossHandler`, `Context`, `distribution/handler.go`, `Context`, `Handler`, `Context`, `Handler`, `Adapter`, `CoretaxService`, `ContractRepository`, `SignatureChallengeService`, `Connection`, `regression_test.go`, `Service`, `UserSafeMessage`, `ParseCSV`, `Context`, `BalanceSheetHandler`, `ExpectedCashFlow`, `Service`, `Handler`, `Handler`, `Money`, `Must`, `distribution/repository.go`, `Handler`, `Handler`, `audit/service_test.go`, `ap/domain.go`, `Handler`, `Adapter`, `sourcing_service.go`, `ContractService`, `SessionFromContext`, `Adapter`, `Handler`, `Handler`, `Decimal`, `ExactAmount`, `CSRFManager`, `runFXCommand`, `Service`, `RouterParams`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `.DecideDecision`, `Handler`, `setupTestDB`, `Handler`, `Handler`, `Handler`, `contracts_domain.go`, `Handler`, `Handler`, `fx_backfill.go`, `midtrans/client.go`, `Service`, `NewFXOpsCLI`, `freight/repository.go`, `.processRows`?**
  _High betweenness centrality (0.192) - this node is a cross-community bridge._
- **Why does `Middleware` connect `Middleware` to `ProfitLossHandler`, `Handler`, `NewHandler`, `Handler`, `Handler`, `WriteHTTPError`, `Handler`, `Handler`, `Handler`, `WriteErrorStatus`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `UserSafeMessage`, `BalanceSheetHandler`, `NewHandler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `SessionFromContext`, `Handler`, `NewHandler`, `Handler`, `Handler`, `CSRFManager`, `Handler`, `Handler`, `RouterParams`, `main`, `NewHandler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `SessionFromContext()` connect `SessionFromContext` to `Middleware`, `ProfitLossHandler`, `Handler`, `Handler`, `MiddlewareStack`, `Handler`, `Handler`, `WriteHTTPError`, `Handler`, `Handler`, `Handler`, `WriteErrorStatus`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `UserSafeMessage`, `BalanceSheetHandler`, `.New`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `PermissionChecker`, `Handler`, `Handler`, `Handler`, `IdentityFromContext`, `ContextWithSession`, `Handler`, `JSONResponse`, `Handler`, `Handler`, `CSRFManager`, `Handler`, `Handler`, `RouterParams`, `Handler`, `Handler`, `Handler`, `Handler`, `main`, `Handler`, `Handler`, `.postCreditNote`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`?**
...
- **Should `models.go` be split into smaller, more focused modules?**
  _Cohesion score 0.019117840190615562 - nodes in this community are weakly interconnected._
