# Graph Report - odyssey-erp  (2026-08-18)

## Corpus Check
- 1509 files · ~977,683 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19092 nodes · 39478 edges · 1291 communities (1206 shown, 85 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 2447 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `80396d85`
...
## Communities (1291 total, 85 thin omitted)

### Community 0 - "models.go"
Cohesion: 0.02
Nodes (332): Addr, Date, Float8, Int8, Numeric, Text, Timestamp, Timestamptz (+324 more)
...
### Community 3 - ".Scan"
Cohesion: 0.03
Nodes (44): Account, AccountType, ArCreditNote, ArCreditNoteStatus, BankLineStatus, BankStatement, BankStatementLine, BankStatementStatus (+36 more)
...
### Community 5 - "Handler"
Cohesion: 0.19
Nodes (12): ContractService, Client, Engine, Logger, Handler, Request, ResponseWriter, Router (+4 more)

### Community 6 - "Context"
Cohesion: 0.06
Nodes (45): AuditEvent, EvidenceRecord, Bool, Context, Int4, Int8, Numeric, PolicyVersion (+37 more)

### Community 7 - "currentUser"
Cohesion: 0.17
Nodes (20): Handler, Request, ResponseWriter, parseIntAt(), queryInt64(), writeContractJSON(), writeScorecardJSON(), currentCompany() (+12 more)
...
### Community 9 - "Context"
Cohesion: 0.07
Nodes (41): APInvoiceValuation, MatchingRun, MatchingRunLine, pgTxRepository, PostAPInvoiceInput, Repository, TxRepository, mapAPDebitNote() (+33 more)
...
Cohesion: 0.07
Nodes (13): MatchingPolicy, memoryAPRepo, memoryAPTx, taxPortFake, VoidAPInvoiceInput, APPaymentAllocation, fmtInt(), APInvoice (+5 more)
...
Cohesion: 0.06
Nodes (35): ARAgingBucket, ARAgingDetail, ARCreditNoteAllocation, ARInvoice, ARInvoiceLine, ARInvoiceStatus, ARInvoiceWithDetails, ARPayment (+27 more)
...
### Community 32 - ".EnqueueDocumentOCR"
Cohesion: 0.20
Nodes (8): Context, HandlerFunc, Client, Service, TaskInfo, HandleDocumentOCR(), NewDocumentOCRTask(), DocumentOCRPayload
...
Cohesion: 0.11
Nodes (16): Audit, AuditFinding, Context, Pool, QualityObjectiveMeasurement, Queries, SupplierAudit, Time (+8 more)
...
Cohesion: 0.10
Nodes (31): Adapter, PaymentEvent, PaymentIntentEventInput, PaymentSettlement, PaymentStatus, PaymentStatusLookup, PaymentTransitionResult, ReconciliationResult (+23 more)
...
Cohesion: 0.08
Nodes (43): hasExactAmount(), normalizeStatus(), Context, Tx, insertSettlementEffectLinks(), validateSettlementEffectLinks(), applyImportedState(), effectMapKey() (+35 more)
...
### Community 56 - "InboxProcessor"
Cohesion: 0.10
Nodes (22): InboxProcessor, InboxRepository, ioDiscard, WebhookHandler, Request, ResponseWriter, Router, NewWebhookHandler() (+14 more)
...
Cohesion: 0.07
Nodes (32): FXRateStatus, TransactionFXCommandOptions, TransactionFXOperations, Context, Time, Writer, parseFXDate(), RunTransactionFXFetch() (+24 more)

### Community 63 - "Context"
Cohesion: 0.13
Nodes (20): Context, DeliveryOrder, Int8, Repository, TxRepository, Pool, Queries, ReturnDeliveryOrder (+12 more)
...
### Community 66 - "NewSessionManager"
Cohesion: 0.13
...
Cohesion: 0.10
Nodes (22): Time, ATETestResult, Audit, AuditFinding, CreateAuditRequest, CreateCAPARequest, CreateInspectionPlanRequest, CreateInspectionRequest (+14 more)
...
### Community 90 - "Task"
Cohesion: 0.06
Nodes (35): ConsolOpsCLI, JobsCLI, QueueStats, Context, TaskInfo, NewConsolOpsCLI(), Client, Context (+27 more)
...
### Community 93 - "SessionFromContext"
Cohesion: 0.08
Nodes (33): CheckoutService, formErrors, AdminHandler, Request, rateLimitKey(), creditNoteURL(), Handler, Request (+25 more)
...
Cohesion: 0.09
Nodes (18): BuildDeliverableMap(), ToDetailResponse(), ToListResponse(), Time, T, TestDeliveryStatusLifecycleRules(), TestReturnStatusLifecycleRules(), DeliveryOrder (+10 more)
...
Cohesion: 0.11
Nodes (21): Row, Lead, Opportunity, Repository, duplicateContact(), Context, Event, Pool (+13 more)
...
Cohesion: 0.06
Nodes (36): Connection, ConnectionStatus, ObjectMapping, OutboxCommand, registryAdapter, SyncRun, Time, Context (+28 more)
...
### Community 116 - "close.sql.go"
Cohesion: 0.19
Nodes (22): Date, Int8, PeriodStatus, Text, Timestamptz, AccountingPeriodStatus, InsertAccountingPeriodParams, InsertCloseRunParams (+14 more)
...
Cohesion: 0.15
Nodes (9): ConnectorDeadLetter, PaymentStatusSnapshot, reconciliationAdapterFake, reconciliationAlertFake, reconciliationStoreFake, Context, PaymentReconciliationIssue, PaymentReconciliationRun (+1 more)

### Community 120 - "connectors/service.go"
Cohesion: 0.06
Nodes (29): checkoutAdapter, checkoutRepo, ConnectionCreateInput, ConnectorDeadLetterWriter, CreateCheckoutIntentRequest, CreateCheckoutIntentResult, CreateConnectionParams, OutboxCommandStateUpdate (+21 more)
...
Cohesion: 0.07
Nodes (5): Accounting Operations, Operating boundaries, Related references, Odyssey ERP Module Catalog, Reporting Catalog
...
Cohesion: 0.11
Nodes (23): AddPlanningRuleRequest, AddRouteStopRequest, AddTransferItemRequest, CreateLoadRequest, CreatePlanningHorizonRequest, CreateShipmentLineRequest, CreateShipmentRequest, CreateTransferOrderRequest (+15 more)
...
### Community 136 - "Text"
Cohesion: 0.09
Nodes (16): Date, Text, InsertAuditFindingParams, InsertAuditParams, InsertCAPAParams, InsertQMSInspectionResultParams, InsertQualityObjectiveMeasurementParams, InsertQualityObjectiveParams (+8 more)
...
### Community 148 - "NewService"
Cohesion: 0.08
Nodes (34): accountingFake, ARCreditNote, ARCreditNoteLine, ARCreditNoteStatus, ARCreditNoteWithDetails, CreateARCreditNoteInput, CreateARCreditNoteLineInput, creditNoteMemoryRepo (+26 more)
...
### Community 157 - "ContractRepository"
Cohesion: 0.15
...
Cohesion: 0.22
Nodes (17): DeliveryRoute, HorizonStatus, Load, LoadItem, LoadStatus, PlanningHorizon, PlanningRule, RouteStop (+9 more)

### Community 174 - "ap/domain.go"
Cohesion: 0.06
Nodes (46): APAgingBucket, APAgingDetail, APAllocationValuation, APInvoice, APInvoiceBalance, APInvoiceLine, APInvoiceStatus, APInvoiceWithDetails (+38 more)
...
Cohesion: 0.07
Nodes (72): ConnectionRef, ErrorCategory, biSnapStatus(), biSnapSuccess(), categoryForTransport(), classifyProviderResponse(), decodeBISNAPResponse(), exactAmount() (+64 more)
...
Cohesion: 0.13
Nodes (29): actionState, badgeView, checklistRowView, checklistSummary, closeRunPageData, closeService, periodListPageData, periodListRow (+21 more)
...
### Community 228 - "sourcing_domain.go"
Cohesion: 0.19
Nodes (15): Money, Time, AwardLineInput, BidLineInput, BidStatus, ComparisonEntry, ComparisonSnapshot, CreateAwardInput (+7 more)
...
Cohesion: 0.11
Nodes (19): T, TestApproveAndRejectRequireSubmittedQuotation(), TestCreateQuotationRejectsBackwardsValidityWindow(), Repository, NewService(), Context, Customer, Quotation (+11 more)
...
### Community 258 - "approval_requests"
Cohesion: 0.22
...
Cohesion: 0.30
Nodes (8): Request, ResponseWriter, Router, Service, NewHandler(), recipientID(), writeJSON(), Handler
...
### Community 300 - "sourcing_service.go"
Cohesion: 0.19
Nodes (13): Client, NewAsynqRFQEmailQueue(), compareDecimal(), AuditPort, Money, Service, lessOrEqualDecimal(), moneyBase() (+5 more)
...
### Community 324 - "Context"
Cohesion: 0.15
Nodes (5): Context, Queries, InsertChecklistItemParams, ListPeriodsParams, UpdateChecklistStatusParams
...
Cohesion: 0.20
Nodes (10): T, TestHTTPNotificationListMarkAllAndIsolation(), TestHTTPUnreadCountAndMarkRead(), Context, Notification, Time, NewService(), normalizeLimit() (+2 more)

### Community 343 - "Handler"
Cohesion: 0.24
Nodes (9): Handler, Renderer, SessionManager, Logger, Request, ResponseWriter, Router, Service (+1 more)

### Community 344 - "NewRegistry"
Cohesion: 0.09
Nodes (26): DefaultRegistry, MockRegistry, PaymentReconciliationAlertSink, PaymentReconciliationIssue, PaymentReconciliationReport, PaymentReconciliationRun, PaymentReconciliationService, PaymentReconciliationStore (+18 more)
...
### Community 355 - "HandlePaymentReconciliation"
Cohesion: 0.22
...
Cohesion: 0.17
Nodes (15): ChecklistDefinition, ChecklistItem, ChecklistStatus, ChecklistUpdateInput, CloseRun, CreatePeriodInput, Period, PeriodStatus (+7 more)
...
### Community 370 - "Client"
Cohesion: 0.13
Nodes (12): Context, Client, TaskInfo, NewClient(), Context, Mutex, T, TestEnqueueSendEmailDeduplicatesByCorrelationID() (+4 more)
...
### Community 386 - "Int4"
Cohesion: 0.14
Nodes (15): Bool, Int4, Time, ApprovalPolicyStep, BoardPack, BoardPackStatus, Load, MrpWorkOrderOperation (+7 more)
...
Cohesion: 0.05
Nodes (38): Engine, Logger, Pool, Router, Service, MountRoutes(), T, TestMountRoutesBuildsDeliveryOrderRoutes() (+30 more)
...
Cohesion: 0.21
Nodes (11): quotationFake, Quotation, QuotationStatus, Time, Context, Quotation, CreateQuotationLineReq, CreateQuotationRequest (+3 more)
...
### Community 414 - "certification_test.go"
Cohesion: 0.35
Nodes (15): envOr(), fetchCSRF(), get(), Client, Duration, Response, T, Values (+7 more)
...
### Community 426 - "calculateComparison"
Cohesion: 0.26
...
### Community 428 - "fakeShipmentGateway"
Cohesion: 0.07
Nodes (25): inventoryDistributionGateway, logisticsDistributionGateway, Dependencies, fakeInventoryGateway, fakeShipmentGateway, InventoryAdjustmentInput, InventoryGateway, ShipmentCreateInput (+17 more)

### Community 429 - "PGRepository"
Cohesion: 0.06
Nodes (35): CanonicalEventInput, InboxEvent, InboxEventInput, paymentInboxFake, PaymentIntentInput, PaymentReconciliationCandidate, PGRepository, Context (+27 more)

### Community 430 - "rbac/repository.go"
Cohesion: 0.28
...
### Community 452 - "BankFeedsProcessor"
Cohesion: 0.25
Nodes (8): Context, Logger, Service, NewBankFeedsEventTask(), NewBankFeedsProcessor(), BankFeedsEventPayload, BankFeedsProcessor, BankFeedsSyncPayload
...
Cohesion: 0.13
Nodes (36): Credentials, Logger, NewAdapter(), encryptedConn(), Logger, M, Request, Response (+28 more)

### Community 455 - "ADR-012: CSS Custom Properties over Utility Framework"
Cohesion: 0.20
...
### Community 477 - "fakeExecutionPort"
Cohesion: 0.31
...
### Community 504 - "settlementServiceFixture"
Cohesion: 0.11
Nodes (40): NewCoordinator(), NewMemoryStore(), NewService(), approvedCoordinator(), Context, Coordinator, Instruction, Submission (+32 more)
...
### Community 515 - "newTestService"
Cohesion: 0.44
Nodes (7): Repository, Service, T, newTestService(), TestGetARAgingDefaultsAsOf(), TestGetKPISummaryCaches(), TestGetPLTrendAndCashflow()
...
### Community 527 - "PayslipProcessor"
Cohesion: 0.44
...
### Community 532 - "CorrectiveAction"
Cohesion: 0.39
Nodes (3): toCAPA(), CorrectiveAction, ListCAPAsFilter
...
### Community 572 - "Manual QA Checklist (Cycle 9.3)"
Cohesion: 0.33
...
### Community 589 - "ComputeElimination"
Cohesion: 0.47
...
### Community 615 - "000112_reporting_administration_phase0.up.sql"
Cohesion: 0.25
...
### Community 616 - "forecasting/service_test.go"
Cohesion: 0.22
...
### Community 907 - "service_pl_test.go"
Cohesion: 0.70
...
Cohesion: 0.06
Nodes (43): HandlerFunc, Location, Logger, RedisClientOpt, Request, ResponseWriter, Router, Server (+35 more)
...
### Community 943 - "DeliveryOrderStatus"
Cohesion: 0.50
...
Cohesion: 0.04
Nodes (48): Architecture Decision Records, Creating a New ADR, Domain-Specific ADRs, Foundational ADRs, Naming Conventions, Template, ADR-0001: Pemilihan Tooling Inti, Keputusan (+40 more)
...
Cohesion: 0.04
Nodes (70): AccountingServicePort, ARAllocationValuation, ARInvoiceValuation, ARPaymentValuation, AuditPort, DeliveryLineInfo, DeliveryOrderInfo, DeliveryServicePort (+62 more)
...
### Community 980 - "Adapter"
Cohesion: 0.14
Nodes (13): Context, Logger, NewAdapter(), Request, Response, T, TestExecuteCommand_SendWhatsAppInExplicitDevelopmentMode(), TestWhatsAppSignatureAndSendContract() (+5 more)
...
### Community 999 - "procurement/service.go"
Cohesion: 0.16
...
### Community 1021 - "tasks.go"
Cohesion: 0.08
Nodes (37): Context, BoardPackPayload, CRMReminderDispatcher, crmReminderFake, FinanceAutomationDispatcher, financeAutomationFake, InsightsWarmupPayload, mailFake (+29 more)
...
### Community 1032 - "PredictiveAnomaly"
Cohesion: 0.20
...
### Community 1102 - "ListSalesOrdersRequest"
Cohesion: 0.48
...
### Community 1157 - "qms/repository.go"
Cohesion: 0.16
Nodes (12): CustomerComplaint, Status, stringStatus(), toComplaint(), toComplaintFromList(), toNCR(), toSupplierQuality(), valueOrZero() (+4 more)
...
### Community 1168 - "orderedBankRepo"
Cohesion: 0.50
...
### Community 1219 - "TestPercentageDifferenceUsesExactPriceMath"
Cohesion: 0.60
...
### Community 1271 - "connector_connections"
Cohesion: 0.12
...
### Community 1276 - "Error Handling"
Cohesion: 0.67
Nodes (3): Business Rule Violations, Error Categories, Error Handling

### Community 1278 - "Odyssey ERP v0.10.0-rc.3 — 2026-08-10"
Cohesion: 0.24
Nodes (7): CI-equivalent verification, HTTP E2E regression, Release-blocking regressions resolved 2026-08-12, Changes since rc.2, Odyssey ERP v0.10.0-rc.3 — 2026-08-10, Remaining promotion gates, Verification
...
- `SessionFromContext()` (2× useful, score=1.615645552)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Parse()` connect `Parse` to `BatchExecutionEnqueuer`, `distribution/handler.go`, `CSRFManager`, `Handler`, `currentUser`, `Context`, `Handler`, `CoretaxService`, `BalanceSheetHandler`, `Handler`, `PermissionsHandler`, `distribution/repository.go`, `Adapter`, `Context`, `SignatureChallengeService`, `Handler`, `Service`, `UserSafeMessage`, `ContractRepository`, `ParseCSV`, `Context`, `regression_test.go`, `ExpectedCashFlow`, `Service`, `logistics/repository.go`, `Handler`, `Handler`, `ProfitLossHandler`, `Money`, `Must`, `ap/domain.go`, `sourcing_service.go`, `NewRouter`, `Handler`, `Handler`, `NewAdapter`, `audit/service_test.go`, `freight/repository.go`, `Adapter`, `midtransiris/adapter.go`, `odyssey/main.go`, `ContractService`, `Handler`, `Adapter`, `.processRows`, `Handler`, `Decimal`, `import.go`, `Service`, `Handler`, `Handler`, `close/http/handler.go`, `Handler`, `Handler`, `Handler`, `Handler`, `.DecideDecision`, `SessionFromContext`, `ExactAmount`, `Handler`, `Handler`, `contracts_domain.go`, `setupTestDB`, `Handler`, `fx_backfill.go`, `Connection`, `Service`, `NewFXOpsCLI`, `Service`, `midtrans/client.go`?**
  _High betweenness centrality (0.199) - this node is a cross-community bridge._
- **Why does `main()` connect `main` to `BatchExecutionEnqueuer`, `Exporter`, `ApprovalRecorder`, `AuditLogger`, `PayslipProcessor`, `BalanceSheetHandler`, `Settlement`, `DebitNotePDFRenderer`, `PermissionsHandler`, `IdempotencyStore`, `CreditNotePDFRenderer`, `Service`, `AsynqOptions`, `ExpectedCashFlow`, `NewMockRepository`, `WalkRoutes`, `fakeShipmentGateway`, `sourcing_service.go`, `NewRouter`, `freight/repository.go`, `InboxProcessor`, `NewPostgresStore`, `odyssey/main.go`, `NewSessionManager`, `.processRows`, `midtrans/adapter_test.go`, `OutboxMessage`, `ExternalReference`, `ap_invoice.go`, `runtime.go`, `forecasting/service.go`, `NewRegistry`, `LoadConfig`, `SessionFromContext`, `SourcingRepository`, `Hooks`, `setupTestDB`, `settlementServiceFixture`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `Connection` connect `Connection` to `Adapter`, `ApplyPaymentTransition`, `midtrans/adapter_test.go`, `PGRepository`, `Adapter`, `Adapter`, `Context`, `Adapter`, `Adapter`, `Adapter`, `connectors/service.go`, `ProviderOptions`?**
...
- **Should `models.go` be split into smaller, more focused modules?**
  _Cohesion score 0.0185607294041029 - nodes in this community are weakly interconnected._
