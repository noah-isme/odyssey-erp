# Graph Report - odyssey-erp  (2026-08-15)

## Corpus Check
- 1507 files · ~975,091 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 19069 nodes · 39415 edges · 1323 communities (1233 shown, 90 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 2443 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2805a078`
...
- header/index.js
- PermissionChecker
- TestBISNAPAccessTokenAndTransactionalSignature
- AuditTimelineAllRow
- Service
- newAuditHandler
- insights.sql.go
...
- TestForecastHandlerRejectsMissingIdentifiers
- mapCarrier
- customerFake
- .InsertSignature
- OverrideService
...
- HTTP E2E regression
- TestMoneyArithmeticDoesNotRoundThroughFloat
- TestRepositoryCRMWorkflow
...
## Communities (1323 total, 90 thin omitted)

### Community 0 - "models.go"
Cohesion: 0.02
Nodes (335): Addr, Date, Float8, Int8, Numeric, Text, Timestamp, Timestamptz (+327 more)
...
### Community 2 - "Handler"
Cohesion: 0.09
Nodes (23): bsPDFRenderer, pdfExporter, PDFRenderClient, plPDFRenderer, productionPDFExporter, NewPDFRenderClient(), Logger, newBSPDFExporter() (+15 more)

### Community 3 - ".Scan"
Cohesion: 0.03
Nodes (38): Account, AccountType, ArCreditNote, ArCreditNoteStatus, ConsolGroupAccount, GoodsReturnGrn, GoodsReturnGrnStatus, NullAccountingPeriodStatus (+30 more)

### Community 4 - "Context"
Cohesion: 0.05
Nodes (42): Carrier, CarrierRateCard, Context, Date, Driver, Fleet, Int4, Int8 (+34 more)

### Community 5 - "ApplyPaymentTransition"
Cohesion: 0.10
...
Cohesion: 0.17
Nodes (9): bankFeedRepoFake, CreateBankConnectionAccountInput, UpdateBankConnectionStatusInput, UpdateBankFeedEventStatusInput, BankConnection, BankConnectionAccount, BankFeedEvent, BankFeedSyncRun (+1 more)

### Community 13 - "Repository"
Cohesion: 0.09
Nodes (30): Repository, Asset, Context, Location, MeterReading, Pool, Queries, Status (+22 more)
...
Cohesion: 0.24
Nodes (12): currentCompany(), currentUser(), Client, Engine, Handler, Logger, Pool, Request (+4 more)
...
Cohesion: 0.09
Nodes (15): ARInvoiceValuation, ARPaymentValuation, CreateARInvoiceInput, CreateARInvoiceLineInput, txRepo, TxRepository, decimalScale(), Repository (+7 more)
...
Cohesion: 0.12
Nodes (14): pgTxRepository, PostAPInvoiceInput, decimalToNumeric(), floatToNumeric(), Context, Date, Int8, Numeric (+6 more)
...
Cohesion: 0.10
Nodes (34): hasExactAmount(), normalizeStatus(), applyImportedState(), effectMapKey(), Context, Instruction, Mutex, PaymentExecution (+26 more)
...
Cohesion: 0.07
Nodes (27): AddSparePartRequest, CreateLocationRequest, CreateMeterReadingRequest, CreateTaskRequest, ListAssetsFilter, PredictiveThresholdRule, Service, ServiceRepository (+19 more)
...
Cohesion: 0.18
Nodes (10): CalibrationRequestedPayload, NormaliseStatus(), currentCompany(), currentUser(), Handler, Request, ResponseWriter, Router (+2 more)
...
### Community 57 - "Scope"
Cohesion: 0.18
Nodes (9): Activity, ActivityInput, notifierFake, Scope, Stage, storeFake, Context, Event (+1 more)
...
Cohesion: 0.11
Nodes (19): Context, Driver, Pool, StopType, Timestamptz, Trip, TripStop, Vehicle (+11 more)

### Community 66 - "Service"
Cohesion: 0.11
Nodes (16): AccountingServicePort, AuditPort, DeliveryLineInfo, DeliveryOrderInfo, DeliveryServicePort, FXRateResolver, RepositoryPort, TaxServicePort (+8 more)
...
Cohesion: 0.25
Nodes (14): Request, ResponseWriter, Router, Service, NewHandler(), treasuryParamID(), writeTreasuryError(), writeTreasuryJSON() (+6 more)
...
Cohesion: 0.09
Nodes (11): fakeDistributionRepository, Context, DeliveryRoute, Load, LoadItem, PlanningHorizon, PlanningRule, RouteStop (+3 more)
...
Cohesion: 0.09
Nodes (22): CarrierRateCard, Context, CreateRateCardInput, Driver, Fleet, Money, Pool, Repository (+14 more)

### Community 81 - "ExternalReference"
Cohesion: 0.12
Nodes (41): ExternalReference, Instruction, Time, allExported(), allowedTransition(), cloneExecution(), Context, Instruction (+33 more)
...
Cohesion: 0.09
Nodes (27): journalPosterFake, ledgerCapture, Time, UUID, defaultReversalMemo(), Context, JournalEntry, JournalLine (+19 more)
...
### Community 90 - "Task"
Cohesion: 0.05
Nodes (39): Context, Logger, Service, NewBankFeedsEventTask(), NewBankFeedsProcessor(), BankFeedsEventPayload, BankFeedsProcessor, BankFeedsSyncPayload (+31 more)
...
Cohesion: 0.12
Nodes (22): Row, Lead, Opportunity, Pipeline, QualifyInput, Repository, Time, duplicateContact() (+14 more)
...
Cohesion: 0.09
Nodes (13): Context, DispositionRequest, DocumentCategory, DocumentClassification, DocumentLink, DocumentReviewStep, Queries, CreateDispositionRequestParams (+5 more)

### Community 108 - "contracts_domain.go"
Cohesion: 0.12
Nodes (20): ContractPriceLine, Money, Time, scanPOContractVariance(), ApprovalStatus, ContractPriceLine, ContractPriceLineInput, ContractStatus (+12 more)
...
Cohesion: 0.10
Nodes (14): Context, PeriodStatus, Queries, Text, InsertChecklistItemParams, InsertCloseRunParams, InsertCloseRunRow, ListPeriodsParams (+6 more)
...
### Community 122 - "connector_connections"
Cohesion: 0.12
Nodes (17): connector_canonical_events, connector_connections, connector_inbox_events, connector_outbox_commands, connector_object_mappings, connector_sync_runs, payment_disputes, payment_intent_transitions (+9 more)

### Community 123 - "Context"
Cohesion: 0.12
Nodes (18): BankStatement, BankStatementLine, Context, Date, Int8, Numeric, Queries, Text (+10 more)
...
Cohesion: 0.14
Nodes (15): integrationInventoryGateway, integrationShipmentGateway, cleanupDistributionFixture(), Context, Pool, Service, ShipmentLine, T (+7 more)
...
Cohesion: 0.09
Nodes (27): AddPlanningRuleRequest, AddRouteStopRequest, AddTransferItemRequest, CreateLoadRequest, CreatePlanningHorizonRequest, CreateShipmentLineRequest, CreateShipmentRequest, CreateTransferOrderRequest (+19 more)
...
Cohesion: 0.19
Nodes (10): accountingFake, creditNoteMemoryRepo, taxFake, Context, T, newCreditNoteMemoryRepo(), TestCreateAndPostCreditNoteFromConfirmedReturn(), TestPostCreditNoteIsIdempotentAndDoesNotDuplicateTaxCapture() (+2 more)
...
Cohesion: 0.06
Nodes (57): AddLoadItemInput, AddRouteStopInput, AddTransferLineInput, CreateLoadInput, CreatePlanningHorizonInput, CreatePlanningRuleInput, CreateRouteInput, CreateTransferOrderInput (+49 more)
...
Cohesion: 0.12
Nodes (21): PGRepository, BankAccount, BankConnection, BankConnectionAccount, BankFeedEvent, BankFeedSyncRun, Context, Pool (+13 more)
...
Cohesion: 0.07
Nodes (33): ARAgingBucket, ARAgingDetail, ARCreditNote, ARCreditNoteAllocation, ARCreditNoteStatus, ARInvoice, ARInvoiceLine, ARInvoiceStatus (+25 more)
...
Cohesion: 0.27
Nodes (14): DeliveryRoute, HorizonStatus, Load, LoadItem, PlanningHorizon, PlanningRule, RouteStop, RuleType (+6 more)

### Community 174 - "Service"
Cohesion: 0.07
Nodes (27): APAllocationValuation, APInvoiceValuation, APPaymentValuation, AuditPort, FXRateResolver, LedgerPostError, TaxServicePort, TransactionalAPAccountingPort (+19 more)
...
Cohesion: 0.05
Nodes (46): cacheItem, ConsolBSEntityContribution, ConsolBSFilters, ConsolBSLine, ConsolBSTotals, ConsolBSViewModel, ConsolPLEntityContribution, ConsolPLFilters (+38 more)
...
### Community 209 - "logistics/repository.go"
Cohesion: 0.12
Nodes (23): coalesceInt64(), floatToNumeric(), Date, Money, Numeric, ShipmentLine, Time, numericToMoney() (+15 more)
...
### Community 228 - "settlementServiceFixture"
Cohesion: 0.13
Nodes (36): NewMemoryStore(), approvedCoordinator(), Context, Coordinator, Instruction, Submission, T, paymentInstruction() (+28 more)
...
Cohesion: 0.07
Nodes (20): CounterVec, Handler, HistogramVec, Registerer, Request, ResponseWriter, NewMetrics(), routePattern() (+12 more)
...
Cohesion: 0.10
Nodes (21): Contribution, DBRepository, Filters, GroupAccountBalance, Member, Service, Totals, TrialBalance (+13 more)

### Community 245 - "memoryProcRepo"
Cohesion: 0.11
...
Cohesion: 0.13
Nodes (26): fxRepository, fxSetupResult, memberBalance, MemberShare, plTotals, ProfitLossContribution, ProfitLossFilters, ProfitLossLine (+18 more)
...
### Community 258 - "close.sql.go"
Cohesion: 0.17
Nodes (24): Int8, Period, PeriodStatus, Timestamptz, int8FromInt64(), int8ToPointer(), legacyStatusFromAccounting(), mapPeriod() (+16 more)
...
Cohesion: 0.25
Nodes (18): AllocationMethod, AuditType, CalculateFreightInput, CalculateFreightOutput, CalculateLandedCostInput, CostCenter, CostCenterType, CreateRateCardInput (+10 more)
...
Cohesion: 0.13
Nodes (15): BalanceSheetHandler, bsPDFExporter, stubBSPDFExporter, Engine, Handler, Logger, Request, ResponseWriter (+7 more)
...
### Community 296 - "predictiveFakeRepository"
Cohesion: 0.21
Nodes (10): PredictiveAlert, predictiveFakeRepository, Context, Repository, T, predictiveIDEqual(), TestPredictiveBatchThresholdFiltersAndKeepsOpenAlertsIdempotent(), TestPredictiveThresholdRejectsNonFiniteReadingAndThreshold() (+2 more)

### Community 297 - "Must"
Cohesion: 0.35
Nodes (8): Must(), Context, Money, ScorecardService, SupplierScorecard, Time, scoreFromCounts(), ScorecardCalculationJob
...
Cohesion: 0.23
Nodes (18): quotationFake, Store, NewService(), Quotation, T, newStoreFake(), TestCRMCreateAndActivityNormalizeCompanyOwnerAndScope(), TestCRMReassignmentRequiresTeamScopeAndNotifiesNewOwner() (+10 more)

### Community 300 - "NewSessionManager"
Cohesion: 0.15
Nodes (10): Client, Context, Duration, Request, ResponseWriter, NewSessionManager(), FlashMessage, Session (+2 more)
...
Cohesion: 0.25
Nodes (10): SalesOrderStatus, Time, Context, Service, SalesOrder, validateFulfillmentLine(), CreateSalesOrderLineReq, CreateSalesOrderRequest (+2 more)
...
### Community 309 - "TestBISNAPAccessTokenAndTransactionalSignature"
Cohesion: 0.27
Nodes (15): Logger, NewAdapter(), NewAdapterWithOptions(), fixtureResponse(), Instruction, Request, Response, T (+7 more)
...
### Community 354 - "Int8"
Cohesion: 0.13
Nodes (8): Int8, GetDocumentVersionRow, InsertDocumentACLParams, InsertDocumentCategoryParams, ReleaseLegalHoldParams, SetCurrentDocumentVersionParams, UpdateDispositionExecutionParams, UpdateDocumentParams

### Community 355 - "ContractRepository"
Cohesion: 0.15
Nodes (10): Context, ContractPriceLine, Money, Pool, SupplierContract, SupplierScorecard, Time, scanSupplierContract() (+2 more)
...
Cohesion: 0.07
Nodes (32): Handler, Handler, Engine, Logger, Request, ResponseWriter, Router, Service (+24 more)
...
Cohesion: 0.29
Nodes (4): Context, Notification, Time, Repository

### Community 394 - "repository"
Cohesion: 0.23
...
Cohesion: 0.13
Nodes (9): Timestamptz, CreateCollaborationChangeParams, CreateCollaborationChangeRow, CreateCollaborationSessionParams, GetDocumentRow, GetLatestDocumentVersionRow, InsertDocumentRetentionParams, InsertDocumentReviewStepParams (+1 more)
...
Cohesion: 0.29
Nodes (6): Handler, Request, ResponseWriter, Router, Service, NewHandler()

### Community 405 - "Int4"
Cohesion: 0.12
Nodes (17): Bool, Int4, Time, ApprovalPolicyStep, BoardPack, BoardPackStatus, DeliveryRoute, Load (+9 more)
...
### Community 407 - "elimination/domain.go"
Cohesion: 0.19
...
Cohesion: 0.28
Nodes (7): Context, Quotation, CalculateLineTotals(), T, TestCalculateLineTotals(), TestCalculateLineTotalsHandlesZeroDiscountAndTax(), Service
...
### Community 412 - "qms/repository.go"
Cohesion: 0.19
...
### Community 414 - "Settlement"
Cohesion: 0.15
Nodes (13): Context, Instruction, Submission, NewProviderRouter(), normalizeProviderName(), Context, Instruction, Submission (+5 more)
...
Cohesion: 0.21
Nodes (22): Service, NewGLPostingService(), freightTestCharge(), freightTestInput(), T, TestPostFreightToGLFailsClosedWithoutAccounting(), TestPostFreightToGLIsIdempotentForExistingSourceLink(), TestPostFreightToGLPostsBalancedExactJournalWithDimensions() (+14 more)
...
### Community 443 - "fakeShipmentGateway"
Cohesion: 0.11
Nodes (16): Dependencies, fakeInventoryGateway, fakeShipmentGateway, InventoryAdjustmentInput, InventoryGateway, RouteOptimizationUpdate, ShipmentCreateInput, ShipmentGateway (+8 more)
...
### Community 446 - "MustParseExact"
Cohesion: 0.14
Nodes (26): MustParseExact(), Context, database, Pool, Tx, insertSettlementEffectLinks(), NewPGSettlementEffects(), NewPGSettlementEffectsWithApplier() (+18 more)
...
### Community 451 - "ap/domain.go"
Cohesion: 0.16
Nodes (22): APAgingBucket, APAgingDetail, APInvoice, APInvoiceBalance, APInvoiceLine, APInvoiceStatus, APInvoiceWithDetails, APPayment (+14 more)

### Community 452 - "ui/contracts.go"
Cohesion: 0.35
...
Cohesion: 0.19
Nodes (6): CreatePMScheduleRequest, PreventiveMaintenanceSchedule, toPMSchedule(), toPMScheduleFromAllDueListRow(), toPMScheduleFromDueListRow(), toPMScheduleFromListRow()
...
### Community 462 - "procurement/domain.go"
Cohesion: 0.14
...
### Community 477 - "sourcing_domain.go"
Cohesion: 0.18
...
### Community 480 - "midtransiris/adapter.go"
Cohesion: 0.06
Nodes (76): ConnectionRef, ErrorCategory, biSnapStatus(), biSnapSuccess(), categoryForTransport(), classifyProviderResponse(), decodeBISNAPResponse(), exactAmount() (+68 more)

### Community 481 - "documents.sql.go"
Cohesion: 0.10
Nodes (13): CreateDocumentOCRJobParams, DeleteDocumentRetentionParams, GetRetentionPolicyForCompanyParams, GetRetentionPolicyForCompanyRow, HasOtherDocumentBlobReferencesParams, ListDocumentsParams, ListDocumentsRow, ListDocumentVersionsParams (+5 more)
...
Cohesion: 0.08
Nodes (24): AgingBucket, AgingFilter, AgingRow, CashflowTrendPoint, mockRepo, MonthlyCashflowRow, MonthlyPLRow, PLTrendPoint (+16 more)
...
Cohesion: 0.17
Nodes (26): newFakeDistributionRepository(), newFakeShipmentGateway(), distributionRequest(), Request, T, TestCreateLoadHandlerRejectsUnauthenticatedRequest(), TestCreateLoadHandlerUsesAuthenticatedCompany(), TestGetLoadRejectsInvalidID() (+18 more)
...
Cohesion: 0.08
Nodes (46): CostCenterUpdate, CreateCostCenterInput, CreateRateSurchargeInput, FreightChargeFilter, FreightChargeStatus, FreightChargeUpdate, LandedCostFilter, postgresRepository (+38 more)
...
Cohesion: 0.19
Nodes (17): barAdapter, lineAdapter, stubRBAC, stubValidator, Context, Handler, T, newTestHandler() (+9 more)
...
### Community 552 - ".GetSparePart"
Cohesion: 0.43
Nodes (3): CreateSparePartRequest, SparePart, toSparePart()
...
Cohesion: 0.19
Nodes (6): ARCreditNoteLine, ARCreditNoteWithDetails, Context, Repository, Context, nullInt64()

### Community 616 - "ComputeElimination"
Cohesion: 0.47
...
Cohesion: 0.09
Nodes (17): ExactAmount, Account, Balance, fakeFeed, InboundEvent, SyncRequest, Transaction, transactionFeedFake (+9 more)
...
Cohesion: 0.07
Nodes (40): ARAllocationValuation, Decimal, FetchRun, FXQuote, FXQuoteSet, OverrideInput, PaymentValuation, RateRepository (+32 more)
...
### Community 1000 - "storage/storage.go"
Cohesion: 0.17
...
### Community 1001 - "approval_requests"
Cohesion: 0.22
Nodes (13): audit_logs, permissions, role_permissions, roles, sessions, user_roles, v_sales_delivery_permissions, approval_assignments (+5 more)
...
### Community 1024 - "sourcing_service.go"
Cohesion: 0.48
Nodes (6): compareDecimal(), Money, lessOrEqualDecimal(), moneyBase(), nonNegativeDecimal(), validateMoney()
...
### Community 1087 - ".ApplySettlementEffectsTx"
Cohesion: 0.28
Nodes (11): Context, Int8, Time, Tx, NewTreasurySettlementEffects(), nullableInt8(), postSettlementJournal(), settlementMapping() (+3 more)
...
### Community 1096 - "companies"
Cohesion: 0.06
Nodes (73): users, companies, accounting_periods, period_close_checklist_items, period_close_runs, elimination_rules, elimination_runs, variance_rules (+65 more)
...
Cohesion: 0.32
Nodes (6): Router, documentsRequestWithSession(), Request, T, TestCreateDocumentRedirectsForInvalidInput(), TestRoutesRequireAuthenticatedPermission()
...
### Community 1160 - "000112_reporting_administration_phase0.up.sql"
Cohesion: 0.25
...
### Community 1165 - "calculateComparison"
Cohesion: 0.23
...
### Community 1168 - "crm/domain.go"
Cohesion: 0.22
Nodes (9): Conversion, CreateLeadInput, CustomerGateway, Event, Notifier, QuotationGateway, ReasonTotal, Store (+1 more)

### Community 1169 - "CRM"
Cohesion: 0.33
Nodes (6): Activities and reminders, CRM, Model and ownership, Permissions, Planned campaign and segmentation depth, Workflow

### Community 1170 - "core/store.js"
Cohesion: 0.36
...
### Community 1222 - "ADR-0002: Role-Based Access Control"
Cohesion: 0.20
...
### Community 1251 - "Manual QA Checklist (Cycle 9.3)"
Cohesion: 0.33
...
### Community 1252 - "SQLRepository"
Cohesion: 0.33
Nodes (6): RateStatus, Context, SQLRepository, Pool, Time, NewRepository()

### Community 1253 - "cmmsRequestWithSession"
Cohesion: 0.53
...
### Community 1254 - "PostgresSettlementResultStore"
Cohesion: 0.36
...
Cohesion: 0.53
Nodes (5): Request, T, TestTreasuryHandlersRejectMissingTenantIdentity(), TestTreasuryHandlersUseTenantIdentityAndImplementFlows(), withTreasuryParams()

### Community 1263 - "NewRepository"
Cohesion: 0.40
Nodes (8): NewRepository(), T, TestRepositoryChannelsDefaultsWhenPreferenceMissing(), TestRepositoryChannelsUsesPreferenceValues(), TestRepositoryCreateIsIdempotentForDeliveryKey(), TestRepositoryMarkAllRead(), TestRepositoryUnreadCountAndMarkRead(), DB

### Community 1264 - "Inspection"
Cohesion: 0.53
...
### Community 1266 - "PayslipProcessor"
Cohesion: 0.38
...
### Community 1270 - "Odyssey ERP: Finance Sandbox Deployment"
Cohesion: 0.50
...
### Community 1275 - "PackingListPayload"
Cohesion: 0.33
...
### Community 1277 - "NewSourcingService"
Cohesion: 0.22
Nodes (8): Client, Context, NewAsynqRFQEmailQueue(), AuditPort, Service, NewSourcingService(), asynqRFQEmailQueue, RFQEmailQueue
...
### Community 1285 - "CreateQuotationRequest"
Cohesion: 0.39
Nodes (7): ConvertInput, QuotationStatus, Time, CreateQuotationLineReq, CreateQuotationRequest, ListQuotationsRequest, UpdateQuotationRequest
...
### Community 1293 - "KPIFilter"
Cohesion: 0.33
Nodes (5): KPIFilter, KPISummary, Service, Context, Time

### Community 1294 - ".InsertLegalHold"
Cohesion: 0.29
...
- `SessionFromContext()` (2× useful, score=1.76692453)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Parse()` connect `Parse` to `sourcing_service.go`, `BatchExecutionEnqueuer`, `freight/repository.go`, `CSRFManager`, `distribution/handler.go`, `Handler`, `ap/repository.go`, `Handler`, `Handler`, `CoretaxService`, `BalanceSheetHandler`, `Handler`, `ExactAmount`, `PermissionsHandler`, `distribution/repository.go`, `Context`, `Connection`, `SignatureChallengeService`, `regression_test.go`, `Service`, `UserSafeMessage`, `ParseCSV`, `Context`, `ExpectedCashFlow`, `Service`, `Handler`, `Handler`, `Money`, `Must`, `Service`, `NewRouter`, `Handler`, `Handler`, `TestBISNAPAccessTokenAndTransactionalSignature`, `audit/service_test.go`, `ConnectionStatus`, `Adapter`, `ProfitLossHandler`, `ContractService`, `SessionFromContext`, `Service`, `Handler`, `Handler`, `Handler`, `import.go`, `Context`, `Service`, `logistics/repository.go`, `PGRepository`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `.DecideDecision`, `Handler`, `midtransiris/adapter.go`, `ContractRepository`, `Handler`, `Handler`, `contracts_domain.go`, `setupTestDB`, `Handler`, `fx_backfill.go`, `.processRows`, `Service`, `NewFXOpsCLI`, `inventory/domain.go`, `midtrans/client.go`, `.processRows`, `runFXCommand`, `OutboxCommand`?**
  _High betweenness centrality (0.211) - this node is a cross-community bridge._
- **Why does `main()` connect `main` to `BatchExecutionEnqueuer`, `freight/repository.go`, `Exporter`, `ApprovalRecorder`, `AuditLogger`, `BalanceSheetHandler`, `DebitNotePDFRenderer`, `PermissionsHandler`, `IdempotencyStore`, `NewSourcingService`, `ReturnDeliveryInfo`, `CreditNotePDFRenderer`, `Settlement`, `AsynqOptions`, `ExpectedCashFlow`, `NewMockRepository`, `WalkRoutes`, `logisticsDistributionGateway`, `NewSessionManager`, `NewRouter`, `NewRegistry`, `ConnectionStatus`, `NewPostgresStore`, `Settings`, `odyssey/main.go`, `SessionFromContext`, `OutboxMessage`, `ExternalReference`, `ap_invoice.go`, `runtime.go`, `Vault`, `forecasting/service.go`, `LoadConfig`, `NewHooks`, `setupTestDB`, `.processRows`, `PayslipProcessor`, `SourcingRepository`, `runFXCommand`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `Connection` connect `Connection` to `OutboxCommand`, `ApplyPaymentTransition`, `midtrans/adapter_test.go`, `Adapter`, `PGRepository`, `CanonicalEvent`, `Adapter`, `Vault`, `Adapter`, `Context`, `Adapter`, `ConnectionStatus`, `Adapter`, `connectors/service.go`, `ProviderOptions`?**
...
- **Should `models.go` be split into smaller, more focused modules?**
  _Cohesion score 0.018387028401865197 - nodes in this community are weakly interconnected._
