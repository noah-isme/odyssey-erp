# Graph Report - odyssey-erp  (2026-08-14)

## Corpus Check
- 1494 files · ~960,943 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 18842 nodes · 38677 edges · 1302 communities (1212 shown, 90 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 2400 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3de91edb`
...
- APException
- NewService
- paymentExecutionFixture
- Handler
- Handler
- Odyssey ERP: Agent Configuration & Guidelines
- forecastRepoFake
- SettlementEffectRequest
- .buildViewModel
- .Bars
- Adapter
- OutboxWorker
...
- runtime.go
- TestWhatsAppSignatureAndSendContract
- .GetSPCChart
...
1. `companies` - 201 edges
2. `SessionFromContext()` - 180 edges
3. `users` - 169 edges
4. `UserSafeMessage()` - 150 edges
5. `Parse()` - 129 edges
6. `Connection` - 112 edges
7. `WriteErrorStatus()` - 108 edges
8. `Middleware` - 97 edges
9. `CSRFManager` - 97 edges
10. `Handler` - 75 edges
...
## Communities (1302 total, 90 thin omitted)

### Community 0 - "models.go"
Cohesion: 0.02
Nodes (332): Date, Float8, Int8, Numeric, Text, Timestamp, Timestamptz, AccountMap (+324 more)
...
### Community 2 - "Handler"
Cohesion: 0.07
Nodes (27): ConsolTBVM, pdfExporter, PDFRenderClient, productionPDFExporter, stubPDFExporter, NewPDFRenderClient(), Engine, Handler (+19 more)
...
### Community 5 - "paymentInboxFake"
Cohesion: 0.07
Nodes (38): Adapter, CanonicalEventInput, InboxEvent, InboxEventInput, PaymentEvent, paymentInboxFake, PaymentIntentEventInput, PaymentSettlement (+30 more)
...
Cohesion: 0.13
Nodes (24): Repository, TxRepository, mapAPDebitNote(), apPaymentSourceID(), dateToTime(), decimalScale(), pgRepository, APInvoice (+16 more)
...
Cohesion: 0.20
Nodes (6): bankFeedRepoFake, BankConnection, BankConnectionAccount, BankFeedEvent, BankFeedSyncRun, Context
...
Cohesion: 0.10
Nodes (29): inventory_serials, inventory_lots, mrp_work_orders, mrp_production_events, mrp_routing_operations, mrp_routings, mrp_work_centers, mrp_material_movements (+21 more)

### Community 15 - "Context"
Cohesion: 0.08
Nodes (12): memoryAPRepo, memoryAPTx, taxPortFake, VoidAPInvoiceInput, APPaymentAllocation, fmtInt(), APInvoice, APInvoiceStatus (+4 more)
...
Cohesion: 0.09
Nodes (15): ARAllocationValuation, ARInvoiceValuation, ARPaymentValuation, txRepo, TxRepository, decimalScale(), Repository, Context (+7 more)

### Community 27 - "main.js"
Cohesion: 0.06
Nodes (32): Charts, Export, FilterBar, Forms, Inspector, Progress, api, Shortcuts (+24 more)
...
Cohesion: 0.08
Nodes (30): formErrors, AdminHandler, Request, rateLimitKey(), debitNoteURL(), Handler, Request, ResponseWriter (+22 more)

### Community 32 - "tasks_test.go"
Cohesion: 0.09
Nodes (23): crmReminderFake, Context, HandlerFunc, Client, Service, TaskInfo, HandleDocumentOCR(), NewDocumentOCRTask() (+15 more)
...
Cohesion: 0.07
Nodes (18): CreateVersionRequest, UpdateDocumentRequest, Context, DispositionRequest, Document, DocumentCategory, DocumentClassification, DocumentLink (+10 more)

### Community 37 - "viewmodel_plbs.go"
Cohesion: 0.13
...
Cohesion: 0.12
Nodes (29): hasExactAmount(), isZeroReference(), normalizeStatus(), applyImportedState(), effectMapKey(), Context, Instruction, Mutex (+21 more)

### Community 40 - "boardpack.sql.go"
Cohesion: 0.08
Nodes (33): AccountType, Context, Date, Int4, Int8, Queries, Text, Timestamptz (+25 more)

### Community 41 - "Handler"
Cohesion: 0.16
Nodes (15): Handler, reportDimension, budgetPeriod(), dimensionFilter(), AuditPort, Engine, Logger, Month (+7 more)
...
Cohesion: 0.07
Nodes (18): DocumentAccessEvent, CreateBlobRequest, DocumentCollaborationSession, ExpiredRetention, Repository, Context, Document, DocumentCategory (+10 more)
...
Cohesion: 0.07
Nodes (28): AddSparePartRequest, CreateLocationRequest, CreateMeterReadingRequest, CreatePMScheduleRequest, CreateSparePartRequest, CreateTaskRequest, ListAssetsFilter, PredictiveThresholdRule (+20 more)
...
Cohesion: 0.10
Nodes (26): Repository, AccountBalance, BoardPack, Company, Context, CreateRequest, Int4, Int8 (+18 more)

### Community 49 - "Handler"
Cohesion: 0.27
Nodes (7): currentCompany(), currentUser(), Handler, Request, ResponseWriter, parseFloat64(), parseInt64()
...
Cohesion: 0.10
Nodes (28): Asset, AssetSpecification, CreateAssetRequest, CreateWorkOrderRequest, IoTReading, IoTSensor, ListWorkOrdersFilter, Location (+20 more)
...
Cohesion: 0.06
Nodes (42): DefaultRegistry, InboxProcessor, InboxRepository, ioDiscard, MockRegistry, ProviderAdapter, WebhookHandler, Request (+34 more)

### Community 57 - "storeFake"
Cohesion: 0.10
Nodes (23): Activity, ActivityInput, Conversion, ConvertInput, CreateLeadInput, CustomerGateway, Event, Lead (+15 more)
...
Cohesion: 0.11
Nodes (23): database, Repository, Settings, SettingsService, SettingsStore, settingsStoreFake, Context, T (+15 more)
...
### Community 66 - "warehouses"
Cohesion: 0.13
Nodes (26): warehouses, inventory_stock_take_lines, inventory_stock_takes, inventory_adjustment_lines, inventory_adjustments, mrp_planning_recommendations, mrp_planning_runs, mrp_product_planning_policies (+18 more)
...
Cohesion: 0.10
Nodes (18): AccountingServicePort, ARAgingBucket, AuditPort, DeliveryLineInfo, DeliveryOrderInfo, DeliveryServicePort, FXRateResolver, RepositoryPort (+10 more)
...
Cohesion: 0.12
Nodes (14): CostCenterUpdate, freightService, LandedCostFilter, RateCardFilter, Context, CostCenter, CreateCostCenterInput, CreateRateCardInput (+6 more)

### Community 80 - "Service"
Cohesion: 0.10
Nodes (21): CarrierRateCard, Context, CreateRateCardInput, Driver, Fleet, Money, Pool, Repository (+13 more)

### Community 81 - "ExternalReference"
Cohesion: 0.14
Nodes (33): ExternalReference, Instruction, Time, allExported(), allowedTransition(), cloneExecution(), Context, Instruction (+25 more)
...
### Community 84 - "main"
Cohesion: 0.17
Nodes (37): main(), member, Registerer, SetupCacheMetrics(), NewProfitLossHandler(), Engine, HistogramVec, Logger (+29 more)
...
Cohesion: 0.09
Nodes (28): journalPosterFake, ledgerCapture, Time, UUID, defaultReversalMemo(), Context, JournalEntry, JournalLine (+20 more)
...
Cohesion: 0.14
Nodes (22): Repository, Context, Int8, Period, PeriodStatus, Pool, Queries, RunStatus (+14 more)
...
### Community 90 - "Task"
Cohesion: 0.05
Nodes (38): Context, Logger, Service, NewBankFeedsEventTask(), NewBankFeedsProcessor(), BankFeedsEventPayload, BankFeedsProcessor, BankFeedsSyncPayload (+30 more)
...
### Community 93 - "UserSafeMessage"
Cohesion: 0.13
Nodes (21): CheckoutService, formErrors, creditNoteURL(), Handler, Request, ResponseWriter, parseID(), getUserID() (+13 more)
...
Cohesion: 0.10
Nodes (18): ToDetailResponse(), ToListResponse(), Time, T, TestDeliveryStatusLifecycleRules(), TestReturnStatusLifecycleRules(), DeliveryOrder, DetailResponse (+10 more)

### Community 99 - "Cache"
Cohesion: 0.12
Nodes (19): Cache, Repository, Cache, Client, Context, Duration, Time, keyAging() (+11 more)
...
### Community 103 - "UUID"
Cohesion: 0.07
Nodes (35): UUID, Context, Int4, Int8, Queries, Text, Timestamptz, UUID (+27 more)
...
### Community 108 - "contracts_domain.go"
Cohesion: 0.12
...
Cohesion: 0.12
Nodes (25): BoardPack, CashflowSummary, Company, CreateRequest, DocumentData, ExecSummaryData, KPISummary, ListFilter (+17 more)
...
Cohesion: 0.11
Nodes (15): stubFXRepo, Context, Time, BalanceRow, FxRateInput, MemberRow, Repository, float64ToNumeric() (+7 more)
...
### Community 122 - "companies"
Cohesion: 0.05
Nodes (69): companies, mrp_audit_events, mrp_controlled_record_policies, mrp_electronic_signatures, prevent_mrp_audit_mutation(), trg_prevent_mrp_audit_mutation, audit_events, compliance_decisions (+61 more)
...
Cohesion: 0.06
Nodes (8): Odyssey ERP Module Catalog, Reporting Catalog, Current position, Highest-value remaining work, Immediate verification, Odyssey ERP: Next Steps and Release Decision Guide, Recommended development sequence, Release rule
...
Cohesion: 0.15
Nodes (17): amountFromNumeric(), Context, Int8, Numeric, Pool, Queries, Text, Time (+9 more)
...
Cohesion: 0.14
Nodes (20): accountDetailData, BankAccountSummary, BankTransactionSummary, CreateAccountInput, CreateTransactionInput, ImportResult, JournalPoster, Repository (+12 more)
...
### Community 136 - "Text"
Cohesion: 0.09
Nodes (16): Date, Text, CountAuditsWithPrefixParams, InsertAuditFindingParams, InsertAuditParams, InsertCAPAParams, InsertQualityObjectiveMeasurementParams, InsertQualityObjectiveParams (+8 more)

### Community 137 - "Repository"
Cohesion: 0.14
Nodes (14): getRun(), Context, Policy, Pool, Run, Tx, UUID, loadRules() (+6 more)
...
Cohesion: 0.15
Nodes (18): AccountBalance, T, sampleBalances(), TestFinanceReportTemplatesExecute(), TestRenderLeavesResponseUntouchedOnTemplateError(), TestRenderStatusAppliesStatusOnSuccess(), TestRenderStatusLeavesResponseUntouchedOnTemplateError(), T (+10 more)
...
Cohesion: 0.25
Nodes (3): Context, Service, WorkOrder
...
### Community 145 - "documents/repository.go"
Cohesion: 0.13
Nodes (9): DispositionRequest, Int8, Pool, Text, int64Ptr(), int8Ptr(), NewRepository(), statusPtr() (+1 more)
...
Cohesion: 0.10
Nodes (18): accountingFake, ARCreditNote, ARCreditNoteLine, ARCreditNoteWithDetails, CreateARCreditNoteInput, CreateARCreditNoteLineInput, creditNoteMemoryRepo, taxFake (+10 more)
...
Cohesion: 0.05
Nodes (32): checkoutAdapter, checkoutRepo, Connection, ConnectionStatus, PaymentIntentInput, registryAdapter, SyncRun, Time (+24 more)

### Community 155 - "Service"
Cohesion: 0.11
Nodes (14): CreateARCreditNoteFromReturnInput, CreditNoteRepositoryPort, PostARCreditNoteInput, returnDeliveryFake, ReturnDeliveryInfo, ReturnDeliveryLineInfo, ReturnDeliveryServicePort, VoidARCreditNoteInput (+6 more)

### Community 156 - "PGRepository"
Cohesion: 0.15
Nodes (17): PGRepository, BankAccount, BankConnection, BankFeedSyncRun, Context, Pool, Queries, Text (+9 more)

### Community 157 - "Context"
Cohesion: 0.11
...
Cohesion: 0.24
Nodes (21): dbFXResolver, fxIDs, allocate(), applyAllMigrations(), assertBalancedAndIdempotent(), assertRevaluation(), assertReversal(), assertValuation() (+13 more)
...
### Community 171 - "ARInvoice"
Cohesion: 0.09
Nodes (26): ARAgingDetail, ARCreditNoteAllocation, ARCreditNoteStatus, ARInvoice, ARInvoiceLine, ARInvoiceStatus, ARInvoiceWithDetails, ARPayment (+18 more)
...
Cohesion: 0.08
Nodes (24): APAgingBucket, APAllocationValuation, APPaymentValuation, AuditPort, FXRateResolver, TaxServicePort, TransactionalAPAccountingPort, TransactionalAPPaymentFXJournalPort (+16 more)
...
### Community 181 - "000112_reporting_administration_phase0.up.sql"
Cohesion: 0.25
...
Cohesion: 0.18
Nodes (22): effects, destroy(), dispatch(), handleClick(), handleDragEnter(), handleDragLeave(), handleDragOver(), handleDrop() (+14 more)

### Community 184 - "Context"
Cohesion: 0.17
Nodes (8): notificationsMemoryStore, notificationsPreferenceFake, notificationsTestStore, Context, Notification, T, Time, TestNotificationAdapterDispatchesApprovalEvents()
...
Cohesion: 0.15
Nodes (11): Service, BoardPack, Company, Context, CreateRequest, ListFilter, Period, Repository (+3 more)

### Community 187 - "qms/service.go"
Cohesion: 0.11
...
### Community 188 - "ProfitLossHandler"
Cohesion: 0.08
Nodes (24): plPDFExporter, plPDFRenderer, ProfitLossHandler, stubPLPDFExporter, Duration, observeVMBuildDuration(), recordCacheHit(), recordCacheMiss() (+16 more)
...
Cohesion: 0.15
Nodes (22): Money, StopType, Time, T, TestServiceRejectsInvalidSetupInputsWithoutRepository(), Carrier, CarrierRateCard, Driver (+14 more)
...
Cohesion: 0.06
Nodes (33): Correlation, dispatcherStoreFake, EnqueueInput, ErrorCategory, OutboxMessage, OutboxRepository, outboxRow, OutboxStatus (+25 more)

### Community 202 - "Service"
Cohesion: 0.19
Nodes (12): LedgerPoster, Service, SimulationSummary, Context, CreateRuleInput, ListFilters, PeriodView, Repository (+4 more)
...
Cohesion: 0.17
Nodes (12): Rat, maxDecimalPlaces(), MustParseAmount(), ParseAmount(), T, TestAmountAdditionIsExact(), TestAmountFromNumericPreservesDecimalText(), TestAmountJSONRequiresDecimalString() (+4 more)
...
### Community 211 - "PGRepository"
Cohesion: 0.07
Nodes (30): BankStatement, BankStatementLine, ParsedStatementLine, PGRepository, Repository, Service, TransferRequest, Reader (+22 more)
...
Cohesion: 0.27
Nodes (25): NewPDFExporter(), createTestPayload(), T, TestBuildPackingListHTML_BasicStructure(), TestBuildPackingListHTML_CustomerInformation(), TestBuildPackingListHTML_DocumentInformation(), TestBuildPackingListHTML_EmptyLines(), TestBuildPackingListHTML_Footer() (+17 more)
...
### Community 238 - "APDebitNote"
Cohesion: 0.15
Nodes (15): APDebitNote, APDebitNoteLine, APDebitNoteStatus, APDebitNoteWithDetails, CreateAPDebitNoteFromReturnInput, CreateAPDebitNoteInput, CreateAPDebitNoteLineInput, ListAPDebitNotesRequest (+7 more)
...
Cohesion: 0.11
Nodes (23): BankAccountCreate, PGRepository, BankAccount, BankStatement, BankTransaction, Context, Int8, Numeric (+15 more)

### Community 241 - "Int8"
Cohesion: 0.12
Nodes (9): Int8, GetCustomerComplaintRow, GetQMSInspectionRow, InsertCustomerComplaintParams, InsertNCRParams, InsertQMSInspectionParams, InsertQMSInspectionPlanParams, ReleaseQMSHoldParams (+1 more)
...
Cohesion: 0.16
Nodes (14): Contribution, DBRepository, Filters, GroupAccountBalance, Member, Service, Totals, TrialBalance (+6 more)

### Community 245 - "procurement/domain.go"
Cohesion: 0.14
...
Cohesion: 0.12
Nodes (15): Time, mapSupplierBankAccount(), Context, mockRepo, PaymentBatchCreate, PaymentBatchExportUpdate, PaymentBatchRevisionUpdate, PaymentBatchSettlementUpdate (+7 more)
...
Cohesion: 0.17
Nodes (8): Context, Pool, Tx, NewSourcingRepository(), Award, AwardStatus, SourcingRepository, storedBidLine
...
Cohesion: 0.21
Nodes (18): effects, destroy(), dispatch(), handleBeforeUnload(), handleClick(), handleKeydown(), handleLoad(), handleResize() (+10 more)
...
Cohesion: 0.14
Nodes (16): mockPoster, mockRepo, StatementImportRunCreate, BankAccount, BankStatement, BankTransaction, Context, JournalEntry (+8 more)
...
Cohesion: 0.26
Nodes (17): AllocationMethod, AuditType, CalculateFreightInput, CalculateFreightOutput, CalculateLandedCostInput, CostCenter, CreateRateCardInput, FreightAuditLog (+9 more)
...
### Community 263 - "BOM"
Cohesion: 0.12
Nodes (19): Time, NewService(), approvedBOM(), Context, T, WorkOrder, TestBOMRevisionRequiresReasonAndStartsDraft(), TestCreateBOMRejectsSelfReferentialAndInvalidScrap() (+11 more)
...
### Community 273 - "BalanceSheetHandler"
Cohesion: 0.08
Nodes (23): BalanceSheetHandler, bsPDFExporter, bsPDFRenderer, stubBSPDFExporter, Engine, Handler, Logger, Request (+15 more)

### Community 274 - "CanonicalEvent"
Cohesion: 0.15
Nodes (16): CanonicalEvent, ObjectMapping, Context, Dispatcher, Logger, Service, NewMarketplaceProcessor(), RegisterOutboxHandlers() (+8 more)
...
Cohesion: 0.17
Nodes (12): normalizeCurrency(), Context, Logger, Time, int64Ptr(), optionalID(), payableAccount(), timePtr() (+4 more)
...
### Community 291 - "HandleReportScheduleScanTask"
Cohesion: 0.25
Nodes (7): NewEmailDeliveryTask(), EmailDeliveryPayload, Client, Context, Logger, Pool, HandleReportScheduleScanTask()
...
### Community 296 - "PredictiveAnomaly"
Cohesion: 0.20
...
### Community 297 - "ScorecardService"
Cohesion: 0.34
Nodes (7): Context, Money, ScorecardService, SupplierScorecard, Time, scoreFromCounts(), ScorecardCalculationJob
...
### Community 300 - "approvedCoordinator"
Cohesion: 0.25
Nodes (20): Coordinator, NewCoordinator(), NewMemoryStore(), NewService(), approvedCoordinator(), Instruction, T, paymentInstruction() (+12 more)
...
Cohesion: 0.22
Nodes (7): Service, Context, Period, Repository, Time, isAllowedChecklistStatus(), NewService()
...
### Community 322 - "Text"
Cohesion: 0.11
Nodes (10): Addr, Text, GetLatestDocumentVersionRow, IndexDocumentSearchParams, InsertDocumentAccessEventParams, InsertDocumentLinkParams, InsertDocumentVersionParams, InsertLegalHoldParams (+2 more)

### Community 323 - "NewDispatcher"
Cohesion: 0.17
Nodes (15): Dispatcher, OperationHandler, OutboxStore, Context, Duration, Logger, RetryPolicy, NewDispatcher() (+7 more)

### Community 324 - "procurement/service.go"
Cohesion: 0.16
...
### Community 334 - "ExactAmount"
Cohesion: 0.18
Nodes (15): ExactAmount, NormalizedStatementEntry, Money, findColumn(), generateFingerprint(), Time, maxIndex(), parseCSV() (+7 more)
...
### Community 336 - "logistics/repository.go"
Cohesion: 0.13
...
### Community 352 - "ContractRepository"
Cohesion: 0.15
...
### Community 354 - "Int8"
Cohesion: 0.13
Nodes (8): Int8, InsertDocumentACLParams, InsertDocumentCategoryParams, InsertDocumentParams, ReleaseLegalHoldParams, SetCurrentDocumentVersionParams, UpdateDispositionExecutionParams, UpdateDocumentParams

### Community 355 - "mockRepo"
Cohesion: 0.16
Nodes (9): MatchingPolicy, MatchingRun, MatchingRunLine, mockRepo, POLineProgress, Context, Mock, Repository (+1 more)
...
Cohesion: 0.19
Nodes (21): apPermissionReader, debitNotePDFFake, apRequest(), Context, Request, T, TestDebitNotePDFDownloadReturnsPDF(), TestDebitNoteRouteRequiresPermission() (+13 more)

### Community 359 - "Snapshot"
Cohesion: 0.15
...
Cohesion: 0.20
Nodes (14): ChecklistDefinition, ChecklistItem, ChecklistStatus, ChecklistUpdateInput, CloseRun, CreatePeriodInput, Period, PeriodStatus (+6 more)
...
### Community 376 - "000083_cmms_qms_tables.up.sql"
Cohesion: 0.16
...
### Community 386 - "StatementArtifact"
Cohesion: 0.17
...
### Community 388 - "CSRFManager"
Cohesion: 0.05
Nodes (37): Engine, Logger, Pool, Router, Service, MountRoutes(), T, TestMountRoutesBuildsDeliveryOrderRoutes() (+29 more)
...
Cohesion: 0.24
Nodes (6): Context, Time, Channels, Notification, preferenceFake, preferenceMatrixFake
...
### Community 394 - "settlementServiceFixture"
Cohesion: 0.26
Nodes (19): MustParseExact(), RegisterPaymentExecutionHandlers(), T, TestPaymentExecutionOutboxAmbiguousOutcomeDeadLettersAndDoesNotResubmit(), TestPaymentResultImportOutboxRetriesTransientEffect(), TestRegisterPaymentExecutionHandlersWiresOnlyConfiguredOperations(), TestUnsupportedSettlementEffectsDoesNotClaimAccountingApplied(), Instruction (+11 more)
...
Cohesion: 0.13
Nodes (9): Timestamptz, CreateCollaborationChangeParams, CreateCollaborationChangeRow, CreateCollaborationSessionParams, GetDocumentRow, GetDocumentVersionRow, InsertDocumentRetentionParams, InsertDocumentReviewStepParams (+1 more)
...
### Community 405 - "Int4"
Cohesion: 0.14
Nodes (16): Bool, Int4, Time, ApprovalPolicyStep, DeliveryRoute, Load, MrpWorkCenterShift, MrpWorkOrderOperation (+8 more)
...
### Community 407 - "PaymentRecoveryMetrics"
Cohesion: 0.15
...
Cohesion: 0.15
Nodes (8): bankingImportFake, transactionFeedFake, ImportResult, Account, Balance, BankAccount, T, TestProcessWebhookEventConvergesThroughIdempotentSync()
...
### Community 424 - "Must"
Cohesion: 0.17
Nodes (19): Service, Must(), T, TestMoneyArithmeticDoesNotRoundThroughFloat(), NewMockRepository(), Repository, NewFreightService(), T (+11 more)
...
### Community 426 - "sourcing_domain.go"
Cohesion: 0.20
Nodes (16): DefaultRFQWeights(), Money, Time, AwardLineInput, BidLineInput, BidStatus, ComparisonEntry, ComparisonSnapshot (+8 more)
...
Cohesion: 0.08
Nodes (25): PGRepository, Context, Numeric, PaymentIntent, PaymentReconciliationIssue, PaymentReconciliationRun, Pool, Queries (+17 more)

### Community 430 - "bank_accounts"
Cohesion: 0.21
...
Cohesion: 0.15
Nodes (9): Context, T, TestCreateRejectsSalesLineAssignedToAnotherFulfillmentWarehouse(), BuildDeliverableMap(), CreateLineReq, DeliverableSOLine, DeliverableSOLinesResponse, fulfillmentWarehouseRepoFake (+1 more)
...
### Community 436 - "variance/repository.go"
Cohesion: 0.30
...
### Community 441 - "paymentExecutionFixture"
Cohesion: 0.22
Nodes (15): Context, PaymentExecution, NewPostgresStore(), PaymentExecution, T, paymentExecutionFixture(), TestPostgresStoreMapsMissingExecution(), TestPostgresStoreRejectsCrossCompanyProviderReferencesBeforeQuery() (+7 more)
...
Cohesion: 0.18
Nodes (9): CreateForecastDailyBucketInput, CreateForecastSourceLineInput, forecastReaderFake, forecastRepoFake, ForecastRunStatusUpdate, Context, ForecastDailyBucket, ForecastRun (+1 more)

### Community 446 - "SettlementEffectRequest"
Cohesion: 0.18
Nodes (12): Context, database, Pool, NewPGSettlementEffects(), NewPostgresSettlementEffects(), Context, Context, PostgresSettlementEffects (+4 more)
...
Cohesion: 0.09
Nodes (28): Header(), Context, Logger, NewAdapter(), Request, Response, T, TestShopifyAdapter_ExplicitDevelopmentCommand() (+20 more)

### Community 450 - "OutboxWorker"
Cohesion: 0.23
Nodes (11): OutboxWorker, OutboxWorkerOption, ProviderRegistry, Context, Logger, NewOutboxWorker(), refundKeyFromPayload(), WithOutboxWorkerLogger() (+3 more)

### Community 451 - "stubRepo"
Cohesion: 0.24
...
### Community 452 - "mapCostCenterValues"
Cohesion: 0.30
Nodes (7): CostCenterType, CreateCostCenterInput, CostCenter, Int8, Timestamptz, int64ToInt8(), mapCostCenterValues()
...
Cohesion: 0.14
Nodes (35): Credentials, NewAdapter(), encryptedConn(), Logger, M, Request, Response, T (+27 more)
...
### Community 457 - "PreventiveMaintenanceSchedule"
Cohesion: 0.24
...
Cohesion: 0.17
Nodes (7): DocumentOCRJob, OCRExtractor, PlainTextOCRExtractor, Context, Service, Reader, isTextContentType()
...
Cohesion: 0.23
Nodes (9): Config, Duration, LoadConfig(), T, TestLoadConfigAcceptsCoreProfile(), TestLoadConfigAcceptsFinanceProfile(), TestLoadConfigRequiresExplicitProfileForStagingAndProduction(), Logger (+1 more)
...
### Community 480 - "memoryRepo"
Cohesion: 0.22
Nodes (6): Context, Quotation, QuotationLine, QuotationStatus, Time, memoryRepo

### Community 481 - "documents.sql.go"
Cohesion: 0.09
Nodes (15): CreateDocumentOCRJobParams, DeleteDocumentRetentionParams, GetActiveRetentionPolicyForVersionRow, GetRetentionPolicyForCompanyParams, GetRetentionPolicyForCompanyRow, HasOtherDocumentBlobReferencesParams, ListDocumentsParams, ListDocumentsRow (+7 more)
...
### Community 498 - "storage/storage.go"
Cohesion: 0.17
...
### Community 504 - "forecasting/service_test.go"
Cohesion: 0.47
Nodes (5): fxResolverFake, T, TestGenerateSnapshotAggregatesFlowsAndPersistsSourceLines(), TestGenerateSnapshotMarksRunIncompleteWhenReaderFails(), TestGenerateSnapshotRejectsForeignScenarioBeforeCreatingRun()
...
Cohesion: 0.14
Nodes (16): AgingBucket, AgingFilter, AgingRow, mockRepo, MonthlyPLRow, PLTrendPoint, TrendFilter, Service (+8 more)
...
### Community 515 - "freight/repository.go"
Cohesion: 0.10
Nodes (37): CreateRateSurchargeInput, FreightChargeFilter, FreightChargeStatus, FreightChargeUpdate, postgresRepository, RateCardUpdate, RateLookup, Repository (+29 more)
...
Cohesion: 0.12
Nodes (16): Adapter, Credentials, roundTripFunc, ShipmentPayload, ProviderPayloadID(), Context, Logger, Response (+8 more)
...
### Community 532 - "Repository"
Cohesion: 0.20
Nodes (9): AccountBalance, Context, ListFilters, PeriodView, Pool, Queries, int8FromInt64(), NewRepository() (+1 more)

### Community 533 - "ContextWithSession"
Cohesion: 0.12
Nodes (23): CashflowTrendPoint, MonthlyCashflowRow, barAdapter, lineAdapter, stubRBAC, stubService, stubValidator, AgingBucket (+15 more)
...
Cohesion: 0.13
Nodes (18): Context, Int8, Permission, Pool, Queries, Role, Time, Timestamptz (+10 more)
...
Cohesion: 0.33
Nodes (6): Current status, Distribution planning and load execution, HTTP endpoints, Inventory and GL behavior, Persistence notes, Tests
...
### Community 615 - "Operations"
Cohesion: 0.32
Nodes (5): Operations, Context, Service, SQLRepository, Time

### Community 616 - "ADR-0002: Role-Based Access Control"
Cohesion: 0.20
...
### Community 654 - "NewHandler"
Cohesion: 0.25
Nodes (10): Engine, Logger, Pool, Service, NewHandler(), cmmsRequestWithSession(), Request, T (+2 more)
...
### Community 907 - ".CreateBid"
Cohesion: 0.35
Nodes (9): TestSourcingDecimalHelpers(), canonicalDecimal(), compareDecimal(), Money, lessOrEqualDecimal(), nonNegativeDecimal(), positiveDecimal(), sumDecimal() (+1 more)
...
### Community 914 - "ConnectionRef"
Cohesion: 0.09
Nodes (21): ConnectionRef, Account, Balance, fakeFeed, InboundEvent, SyncRequest, Transaction, TransactionPage (+13 more)
...
### Community 920 - "NewGLPostingService"
Cohesion: 0.58
...
### Community 926 - "override_test.go"
Cohesion: 0.24
Nodes (6): overrideAuth, overrideRepo, Context, overrideAudit, T, TestOverrideRequiresAuthorization()
...
Cohesion: 0.07
Nodes (35): HandlerFunc, Location, Logger, RedisClientOpt, Request, ResponseWriter, Router, Server (+27 more)
...
### Community 942 - "fx_daily_rates_test.go"
Cohesion: 0.27
...
### Community 943 - "elimination/domain.go"
Cohesion: 0.23
Nodes (9): CreateRuleInput, ListFilters, PeriodView, Rule, Run, RunStatus, UpdateRuleInput, FormatMemo() (+1 more)
...
Cohesion: 0.24
Nodes (10): BankAccount, BankStatement, BankStatementCreate, BankStatementLineCreate, BankTransaction, BankTransactionCreate, BankTransactionStatusUpdate, StatementImportRun (+2 more)
...
### Community 958 - "calculateComparison"
Cohesion: 0.33
Nodes (7): calculateComparison(), Rat, T, TestCalculateComparisonHandlesZeroPricedBidsWithoutDivisionByZero(), TestCalculateComparisonRanksEachRFQLineWithExactAmounts(), weightedScore(), comparisonCandidate
...
Cohesion: 0.04
Nodes (48): ADR-012: CSS Custom Properties over Utility Framework, Alternatives, Consequences, Context, Date, Decision, Negative, Positive (+40 more)
...
Cohesion: 0.07
Nodes (38): Decimal, FetchRun, FXQuote, FXQuoteSet, OverrideInput, PaymentValuation, RateRepository, Resolver (+30 more)
...
Cohesion: 0.28
Nodes (6): dimensionRows, T, TestAccountingRequestHelpers(), TestNewHandlerMountsAccountingRoutes(), TestRowsToDimensionMaps(), rowsToDimensionMaps()
...
### Community 980 - "TestWhatsAppSignatureAndSendContract"
Cohesion: 0.32
Nodes (6): Request, Response, T, TestExecuteCommand_SendWhatsAppInExplicitDevelopmentMode(), TestWhatsAppSignatureAndSendContract(), roundTripFunc

### Community 981 - ".GetSPCChart"
Cohesion: 0.31
...
Cohesion: 0.31
Nodes (4): mapPaymentBatchItem(), CSVEncoder, PaymentBatchItem, PaymentBatchItemCreate
...
### Community 1030 - "MockReader"
Cohesion: 0.24
Nodes (6): Certainty, MockReader, SourceType, Context, Time, NewMockReader()

### Community 1031 - "SourcingService"
Cohesion: 0.28
Nodes (6): AuditPort, Context, Request, Service, NewSourcingService(), SourcingService
...
Cohesion: 0.13
Nodes (11): CreateCategoryRequest, CreateDispositionRequest, CreateLinkRequest, ReviewDecisionRequest, DocumentLink, DocumentReviewDecision, Context, DispositionRequest (+3 more)
...
Cohesion: 0.15
Nodes (12): Native Development Setup, Prerequisites, Run the application, Start infrastructure, Cek Password PostgreSQL Default, Jika Masih Stuck, Opsi 1: Set Password PostgreSQL User (Paling Cepat), Opsi 2: Manual SQL Execution (Copy-Paste) (+4 more)
...
### Community 1076 - "NewClient"
Cohesion: 0.27
Nodes (7): NewClient(), Context, Mutex, T, TestEnqueueSendEmailDeduplicatesByCorrelationID(), TestWorkerRetriesSendEmailAfterSMTPFailure(), retryMailer

### Community 1077 - "BuildBalanceSheet"
Cohesion: 0.27
Nodes (9): BuildBalanceSheet(), AccountBalance, T, TestBuildBalanceSheet(), TestBuildProfitAndLoss(), TestBuildTrialBalance(), BalanceSheet, BalanceSheetAccount (+1 more)
...
### Community 1087 - "NewPostgresSettlementService"
Cohesion: 0.23
Nodes (9): Context, database, Pool, NewPGSettlementResultStore(), NewPostgresSettlementResultStore(), Pool, NewPostgresSettlementService(), NewUnsupportedSettlementEffects() (+1 more)

### Community 1088 - "crm_opportunities"
Cohesion: 0.42
...
### Community 1089 - "PackingListPayload"
Cohesion: 0.33
Nodes (6): PackingListLine, PackingListPayload, Client, Context, PDFExporter, Time

### Community 1090 - "mapShipment"
Cohesion: 0.31
...
Cohesion: 0.08
Nodes (39): audit_logs, permissions, role_permissions, roles, sessions, user_roles, users, branches (+31 more)
...
### Community 1102 - ".InsertLegalHold"
Cohesion: 0.29
...
### Community 1136 - "HandleCMMSPMGeneratorScanTask"
Cohesion: 0.25
...
### Community 1151 - "mapBankConnectionAccount"
Cohesion: 0.53
Nodes (3): CreateBankConnectionAccountInput, BankConnectionAccount, mapBankConnectionAccount()

### Community 1152 - "CreditNotePDFRenderer"
Cohesion: 0.36
...
### Community 1162 - "OverrideService"
Cohesion: 0.70
Nodes (4): OverrideAuthorizer, OverrideRepository, OverrideService, OverrideAudit
...
### Community 1164 - "Cross-Module Lifecycle Reference"
Cohesion: 0.67
Nodes (3): Cross-Module Lifecycle Reference, Explicitly not covered, Module notes

### Community 1165 - "NewAsynqRFQEmailQueue"
Cohesion: 0.50
Nodes (4): Client, NewAsynqRFQEmailQueue(), asynqRFQEmailQueue, RFQEmailQueue

### Community 1168 - ".CreateCollaborationSession"
Cohesion: 0.47
Nodes (3): Context, Document, Service

### Community 1169 - "CRM"
Cohesion: 0.33
Nodes (6): Activities and reminders, CRM, Model and ownership, Permissions, Planned campaign and segmentation depth, Workflow

### Community 1170 - "BuildTrialBalance"
Cohesion: 0.46
Nodes (5): BuildTrialBalance(), AccountBalance, TrialBalance, TrialBalanceAccount, TrialBalanceGroup
...
### Community 1219 - "ComputeElimination"
Cohesion: 0.47
Nodes (4): ComputeElimination(), round2(), T, TestComputeElimination()

### Community 1220 - "banking/service_edges_test.go"
Cohesion: 0.24
...
### Community 1229 - "ADR-0006: Bank ownership and feed ingestion"
Cohesion: 0.50
...
### Community 1232 - "Integration Points"
Cohesion: 0.40
...
### Community 1251 - "mapCarrier"
Cohesion: 0.53
Nodes (3): Carrier, mapCarrier(), CarrierStatus

### Community 1252 - "automation/repository_test.go"
Cohesion: 0.39
...
### Community 1263 - "KPIFilter"
Cohesion: 0.33
Nodes (5): KPIFilter, KPISummary, Service, Context, Time

### Community 1264 - "NewService"
Cohesion: 0.40
...
### Community 1283 - "Documentation Status"
Cohesion: 0.67
...
### Community 1290 - "ADR-0009: Asset capitalization and operations"
Cohesion: 0.67
Nodes (3): ADR-0009: Asset capitalization and operations, Consequences, Decision

### Community 1293 - "Accounting Operations"
Cohesion: 0.67
Nodes (3): Accounting Operations, Operating boundaries, Related references

### Community 1294 - "HTTP E2E regression"
Cohesion: 0.67
Nodes (3): CI-equivalent verification, HTTP E2E regression, Release-blocking regressions resolved 2026-08-12

### Community 1295 - "Authoritative Feature Matrix"
Cohesion: 0.67
Nodes (3): Authoritative Feature Matrix, Release interpretation, Status definitions

### Community 1296 - "Panduan Finance Insights"
Cohesion: 0.67
Nodes (3): Catatan Implementasi, Filter Awal, Panduan Finance Insights

## Knowledge Gaps
- **3027 isolated node(s):** `FXOpsCLI`, `FXOpsCLI`, `github.com/odyssey-erp/odyssey-erp`, `Handler`, `Asset` (+3022 more)
...
- `SessionFromContext()` (2× useful, score=1.804892442)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Parse()` connect `Parse` to `freight/repository.go`, `distribution/handler.go`, `CSRFManager`, `Handler`, `ap/repository.go`, `Handler`, `.CreateBid`, `Adapter`, `CoretaxService`, `BalanceSheetHandler`, `PermissionsHandler`, `distribution/repository.go`, `Context`, `SignatureChallengeService`, `regression_test.go`, `Service`, `SessionFromContext`, `ParseCSV`, `Context`, `ExpectedCashFlow`, `Service`, `Must`, `Handler`, `Handler`, `Money`, `NewRouter`, `Handler`, `Handler`, `Handler`, `audit/service_test.go`, `NewRegistry`, `Handler`, `ProfitLossHandler`, `Adapter`, `ContractService`, `Handler`, `Adapter`, `Handler`, `Service`, `Decimal`, `Handler`, `ExactAmount`, `Service`, `PGRepository`, `Handler`, `Handler`, `Handler`, `Handler`, `Handler`, `.DecideDecision`, `UserSafeMessage`, `Handler`, `ContractRepository`, `numericToMoney`, `setupTestDB`, `Handler`, `runFXCommand`, `Handler`, `contracts_domain.go`, `Handler`, `fx_backfill.go`, `Service`, `NewFXOpsCLI`, `midtrans/client.go`, `.processRows`, `OutboxCommand`?**
  _High betweenness centrality (0.186) - this node is a cross-community bridge._
- **Why does `Connection` connect `Connection` to `Adapter`, `paymentInboxFake`, `midtrans/adapter_test.go`, `PGRepository`, `Adapter`, `Adapter`, `Context`, `Adapter`, `OutboxCommand`, `Adapter`, `connectors/service.go`, `ProviderOptions`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `main()` connect `main` to `CreditNotePDFRenderer`, `NewSessionManager`, `freight/repository.go`, `SourcingService`, `Exporter`, `NewAsynqRFQEmailQueue`, `ApprovalRecorder`, `AuditLogger`, `BalanceSheetHandler`, `PayslipProcessor`, `DebitNotePDFRenderer`, `PermissionsHandler`, `IdempotencyStore`, `Service`, `SessionFromContext`, `AsynqOptions`, `ExpectedCashFlow`, `Must`, `WalkRoutes`, `logisticsDistributionGateway`, `NewRouter`, `NewRegistry`, `odyssey/main.go`, `midtrans/adapter_test.go`, `ap_invoice.go`, `runtime.go`, `forecasting/service.go`, `LoadConfig`, `NewHooks`, `setupTestDB`, `runFXCommand`, `SourcingRepository`, `.processRows`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Are the 176 inferred relationships involving `SessionFromContext()` (e.g. with `.auditRecord()` and `.companyID()`) actually correct?**
  _`SessionFromContext()` has 176 INFERRED edges - model-reasoned connections that need verification._
...
- **Should `models.go` be split into smaller, more focused modules?**
  _Cohesion score 0.01868335401269533 - nodes in this community are weakly interconnected._
