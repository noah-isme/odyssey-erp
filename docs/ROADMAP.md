...
| Payment gateway — Midtrans (Phase A1) | ✅ Implemented | Snap checkout, SHA-512 webhook signature verification, monotonic lifecycle/replay handling, expiry/refunds, timeout status recovery, payout reconciliation, automatic AR allocation, and deterministic sandbox certification; `internal/connectors/providers/midtrans/` |
